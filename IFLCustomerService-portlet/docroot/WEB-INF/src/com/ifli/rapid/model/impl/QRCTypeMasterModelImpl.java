...
import com.ifli.rapid.model.QRCTypeMasterModel;
...
/**
 * The base model implementation for the QRCTypeMaster service. Represents a row in the &quot;QRC_TYPE_MASTER&quot; database table, with each column mapped to a property of this class.
 *
 * <p>
 * This implementation and its corresponding interface {@link com.ifli.rapid.model.QRCTypeMasterModel} exist only as a container for the default property accessors generated by ServiceBuilder. Helper methods and all application logic should be put in {@link QRCTypeMasterImpl}.
 * </p>
 *
 * @author Satya Kola
 * @see QRCTypeMasterImpl
 * @see com.ifli.rapid.model.QRCTypeMaster
 * @see com.ifli.rapid.model.QRCTypeMasterModel
 * @generated
 */
public class QRCTypeMasterModelImpl extends BaseModelImpl<QRCTypeMaster>
	implements QRCTypeMasterModel {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. All methods that expect a q r c type master model instance should use the {@link com.ifli.rapid.model.QRCTypeMaster} interface instead.
	 */
	public static final String TABLE_NAME = "QRC_TYPE_MASTER";
	public static final Object[][] TABLE_COLUMNS = {
			{ "QRC_TYPE_ID", Types.INTEGER },
			{ "TYPE_DESC", Types.VARCHAR },
	...
	public static final String TABLE_SQL_CREATE = "create table QRC_TYPE_MASTER (QRC_TYPE_ID INTEGER not null primary key IDENTITY,TYPE_DESC VARCHAR(75) null,ACTIVE_FLAG VARCHAR(75) null,INSERTED_DATE DATE null,INSERTED_BY VARCHAR(75) null,UPDATED_DATE DATE null,UPDATED_BY VARCHAR(75) null,DELETED_DATE DATE null,DELETED_BY VARCHAR(75) null)";
	public static final String TABLE_SQL_DROP = "drop table QRC_TYPE_MASTER";
	public static final String ORDER_BY_JPQL = " ORDER BY qrcTypeMaster.QRC_TYPE_ID ASC";
	public static final String ORDER_BY_SQL = " ORDER BY QRC_TYPE_MASTER.QRC_TYPE_ID ASC";
	...
	public static final boolean ENTITY_CACHE_ENABLED = GetterUtil.getBoolean(com.liferay.util.service.ServiceProps.get(
				"value.object.entity.cache.enabled.com.ifli.rapid.model.QRCTypeMaster"),
			true);
	public static final boolean FINDER_CACHE_ENABLED = GetterUtil.getBoolean(com.liferay.util.service.ServiceProps.get(
				"value.object.finder.cache.enabled.com.ifli.rapid.model.QRCTypeMaster"),
			true);
	public static final boolean COLUMN_BITMASK_ENABLED = false;
	public static final long LOCK_EXPIRATION_TIME = GetterUtil.getLong(com.liferay.util.service.ServiceProps.get(
				"lock.expiration.time.com.ifli.rapid.model.QRCTypeMaster"));

	public QRCTypeMasterModelImpl() {
	}
	...
	public QRCTypeMaster toEscapedModel() {
		if (_escapedModel == null) {
			_escapedModel = (QRCTypeMaster)ProxyUtil.newProxyInstance(_classLoader,
	...
	public Object clone() {
		...
		qrcTypeMasterImpl.setQRC_TYPE_ID(getQRC_TYPE_ID());
		qrcTypeMasterImpl.setTYPE_DESC(getTYPE_DESC());
		qrcTypeMasterImpl.setACTIVE_FLAG(getACTIVE_FLAG());
		qrcTypeMasterImpl.setINSERTED_DATE(getINSERTED_DATE());
		qrcTypeMasterImpl.setINSERTED_BY(getINSERTED_BY());
		qrcTypeMasterImpl.setUPDATED_DATE(getUPDATED_DATE());
		qrcTypeMasterImpl.setUPDATED_BY(getUPDATED_BY());
		qrcTypeMasterImpl.setDELETED_DATE(getDELETED_DATE());
		qrcTypeMasterImpl.setDELETED_BY(getDELETED_BY());
	...
	public boolean equals(Object obj) {
		...
		if (!(obj instanceof QRCTypeMaster)) {
			return false;
		}

		QRCTypeMaster qrcTypeMaster = (QRCTypeMaster)obj;
	...
	public CacheModel<QRCTypeMaster> toCacheModel() {
		QRCTypeMasterCacheModel qrcTypeMasterCacheModel = new QRCTypeMasterCacheModel();

		qrcTypeMasterCacheModel.QRC_TYPE_ID = getQRC_TYPE_ID();

		qrcTypeMasterCacheModel.TYPE_DESC = getTYPE_DESC();

		String TYPE_DESC = qrcTypeMasterCacheModel.TYPE_DESC;

		if ((TYPE_DESC != null) && (TYPE_DESC.length() == 0)) {
			qrcTypeMasterCacheModel.TYPE_DESC = null;
		}

		qrcTypeMasterCacheModel.ACTIVE_FLAG = getACTIVE_FLAG();

		String ACTIVE_FLAG = qrcTypeMasterCacheModel.ACTIVE_FLAG;

		if ((ACTIVE_FLAG != null) && (ACTIVE_FLAG.length() == 0)) {
			qrcTypeMasterCacheModel.ACTIVE_FLAG = null;
		}

		Date INSERTED_DATE = getINSERTED_DATE();

		if (INSERTED_DATE != null) {
			qrcTypeMasterCacheModel.INSERTED_DATE = INSERTED_DATE.getTime();
		}
		else {
			qrcTypeMasterCacheModel.INSERTED_DATE = Long.MIN_VALUE;
		}

		qrcTypeMasterCacheModel.INSERTED_BY = getINSERTED_BY();

		String INSERTED_BY = qrcTypeMasterCacheModel.INSERTED_BY;

		if ((INSERTED_BY != null) && (INSERTED_BY.length() == 0)) {
			qrcTypeMasterCacheModel.INSERTED_BY = null;
		}

		Date UPDATED_DATE = getUPDATED_DATE();

		if (UPDATED_DATE != null) {
			qrcTypeMasterCacheModel.UPDATED_DATE = UPDATED_DATE.getTime();
		}
		else {
			qrcTypeMasterCacheModel.UPDATED_DATE = Long.MIN_VALUE;
		}

		qrcTypeMasterCacheModel.UPDATED_BY = getUPDATED_BY();

		String UPDATED_BY = qrcTypeMasterCacheModel.UPDATED_BY;

		if ((UPDATED_BY != null) && (UPDATED_BY.length() == 0)) {
			qrcTypeMasterCacheModel.UPDATED_BY = null;
		}

		Date DELETED_DATE = getDELETED_DATE();

		if (DELETED_DATE != null) {
			qrcTypeMasterCacheModel.DELETED_DATE = DELETED_DATE.getTime();
		}
		else {
			qrcTypeMasterCacheModel.DELETED_DATE = Long.MIN_VALUE;
		}

		qrcTypeMasterCacheModel.DELETED_BY = getDELETED_BY();

		String DELETED_BY = qrcTypeMasterCacheModel.DELETED_BY;

		if ((DELETED_BY != null) && (DELETED_BY.length() == 0)) {
			qrcTypeMasterCacheModel.DELETED_BY = null;
		}

		return qrcTypeMasterCacheModel;
	}
	...
	private static ClassLoader _classLoader = QRCTypeMaster.class.getClassLoader();
	...
	private QRCTypeMaster _escapedModel;
}