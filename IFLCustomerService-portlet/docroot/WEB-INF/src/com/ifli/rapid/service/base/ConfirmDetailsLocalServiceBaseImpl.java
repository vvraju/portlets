...
import com.ifli.rapid.service.ConfirmDetailsLocalService;
...
/**
 * Provides the base implementation for the confirm details local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.ifli.rapid.service.impl.ConfirmDetailsLocalServiceImpl}.
 * </p>
 *
 * @author Satya Kola
 * @see com.ifli.rapid.service.impl.ConfirmDetailsLocalServiceImpl
 * @see com.ifli.rapid.service.ConfirmDetailsLocalServiceUtil
 * @generated
 */
public abstract class ConfirmDetailsLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements ConfirmDetailsLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.ifli.rapid.service.ConfirmDetailsLocalServiceUtil} to access the confirm details local service.
	 */
	...
	@Override
	public ConfirmDetails addConfirmDetails(ConfirmDetails confirmDetails)
		throws SystemException {
		confirmDetails.setNew(true);

		return confirmDetailsPersistence.update(confirmDetails);
	}
	 ...
	 */
	@Override
	public ConfirmDetails createConfirmDetails(int ID) {
		return confirmDetailsPersistence.create(ID);
	}
	...
	@Override
	public ConfirmDetails deleteConfirmDetails(int ID)
		throws PortalException, SystemException {
		return confirmDetailsPersistence.remove(ID);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public ConfirmDetails deleteConfirmDetails(ConfirmDetails confirmDetails)
		throws SystemException {
		return confirmDetailsPersistence.remove(confirmDetails);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(ConfirmDetails.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		throws SystemException {
		return confirmDetailsPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return confirmDetailsPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public ConfirmDetails fetchConfirmDetails(int ID) throws SystemException {
		return confirmDetailsPersistence.fetchByPrimaryKey(ID);
	}
	 ...
	 */
	@Override
	public ConfirmDetails getConfirmDetails(int ID)
		throws PortalException, SystemException {
		return confirmDetailsPersistence.findByPrimaryKey(ID);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return confirmDetailsPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<ConfirmDetails> getConfirmDetailses(int start, int end)
		throws SystemException {
		return confirmDetailsPersistence.findAll(start, end);
	}
	 ...
	 */
	@Override
	public int getConfirmDetailsesCount() throws SystemException {
		return confirmDetailsPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public ConfirmDetails updateConfirmDetails(ConfirmDetails confirmDetails)
		throws SystemException {
		return confirmDetailsPersistence.update(confirmDetails);
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("com.ifli.rapid.model.ConfirmDetails",
			confirmDetailsLocalService);
	}

	public void destroy() {
		PersistedModelLocalServiceRegistryUtil.unregister(
			"com.ifli.rapid.model.ConfirmDetails");
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = confirmDetailsPersistence.getDataSource();
	...
	private ConfirmDetailsLocalServiceClpInvoker _clpInvoker = new ConfirmDetailsLocalServiceClpInvoker();
}