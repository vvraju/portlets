...
import com.ifli.rapid.service.CustomerOtpLocalService;
...
/**
 * Provides the base implementation for the customer otp local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.ifli.rapid.service.impl.CustomerOtpLocalServiceImpl}.
 * </p>
 *
 * @author Satya Kola
 * @see com.ifli.rapid.service.impl.CustomerOtpLocalServiceImpl
 * @see com.ifli.rapid.service.CustomerOtpLocalServiceUtil
 * @generated
 */
public abstract class CustomerOtpLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements CustomerOtpLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.ifli.rapid.service.CustomerOtpLocalServiceUtil} to access the customer otp local service.
	 */
	...
	@Override
	public CustomerOtp addCustomerOtp(CustomerOtp customerOtp)
		throws SystemException {
		customerOtp.setNew(true);

		return customerOtpPersistence.update(customerOtp);
	}
	 ...
	 */
	@Override
	public CustomerOtp createCustomerOtp(int CUSTOMER_ID) {
		return customerOtpPersistence.create(CUSTOMER_ID);
	}
	...
	@Override
	public CustomerOtp deleteCustomerOtp(int CUSTOMER_ID)
		throws PortalException, SystemException {
		return customerOtpPersistence.remove(CUSTOMER_ID);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public CustomerOtp deleteCustomerOtp(CustomerOtp customerOtp)
		throws SystemException {
		return customerOtpPersistence.remove(customerOtp);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(CustomerOtp.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		throws SystemException {
		return customerOtpPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public List dynamicQuery(DynamicQuery dynamicQuery, int start, int end)
		throws SystemException {
		return customerOtpPersistence.findWithDynamicQuery(dynamicQuery, start,
			end);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return customerOtpPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public CustomerOtp fetchCustomerOtp(int CUSTOMER_ID)
		throws SystemException {
		return customerOtpPersistence.fetchByPrimaryKey(CUSTOMER_ID);
	}
	 ...
	 */
	@Override
	public CustomerOtp getCustomerOtp(int CUSTOMER_ID)
		throws PortalException, SystemException {
		return customerOtpPersistence.findByPrimaryKey(CUSTOMER_ID);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return customerOtpPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<CustomerOtp> getCustomerOtps(int start, int end)
		throws SystemException {
		return customerOtpPersistence.findAll(start, end);
	}
	 ...
	 */
	@Override
	public int getCustomerOtpsCount() throws SystemException {
		return customerOtpPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public CustomerOtp updateCustomerOtp(CustomerOtp customerOtp)
		throws SystemException {
		return customerOtpPersistence.update(customerOtp);
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("com.ifli.rapid.model.CustomerOtp",
			customerOtpLocalService);
	}

	public void destroy() {
		PersistedModelLocalServiceRegistryUtil.unregister(
			"com.ifli.rapid.model.CustomerOtp");
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = customerOtpPersistence.getDataSource();
	...
	private CustomerOtpLocalServiceClpInvoker _clpInvoker = new CustomerOtpLocalServiceClpInvoker();
}