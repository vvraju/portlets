...
import com.ifli.rapid.service.PaymentGatewayMasterLocalService;
...
/**
 * Provides the base implementation for the payment gateway master local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.ifli.rapid.service.impl.PaymentGatewayMasterLocalServiceImpl}.
 * </p>
 *
 * @author Satya Kola
 * @see com.ifli.rapid.service.impl.PaymentGatewayMasterLocalServiceImpl
 * @see com.ifli.rapid.service.PaymentGatewayMasterLocalServiceUtil
 * @generated
 */
public abstract class PaymentGatewayMasterLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements PaymentGatewayMasterLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.ifli.rapid.service.PaymentGatewayMasterLocalServiceUtil} to access the payment gateway master local service.
	 */
	...
	@Override
	public PaymentGatewayMaster addPaymentGatewayMaster(
		PaymentGatewayMaster paymentGatewayMaster) throws SystemException {
		paymentGatewayMaster.setNew(true);

		return paymentGatewayMasterPersistence.update(paymentGatewayMaster);
	}
	 ...
	 */
	@Override
	public PaymentGatewayMaster createPaymentGatewayMaster(String GatewayID) {
		return paymentGatewayMasterPersistence.create(GatewayID);
	}
	...
	@Override
	public PaymentGatewayMaster deletePaymentGatewayMaster(String GatewayID)
		throws PortalException, SystemException {
		return paymentGatewayMasterPersistence.remove(GatewayID);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public PaymentGatewayMaster deletePaymentGatewayMaster(
		PaymentGatewayMaster paymentGatewayMaster) throws SystemException {
		return paymentGatewayMasterPersistence.remove(paymentGatewayMaster);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(PaymentGatewayMaster.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		...
		return paymentGatewayMasterPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return paymentGatewayMasterPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public PaymentGatewayMaster fetchPaymentGatewayMaster(String GatewayID)
		throws SystemException {
		return paymentGatewayMasterPersistence.fetchByPrimaryKey(GatewayID);
	}
	 ...
	 */
	@Override
	public PaymentGatewayMaster getPaymentGatewayMaster(String GatewayID)
		throws PortalException, SystemException {
		return paymentGatewayMasterPersistence.findByPrimaryKey(GatewayID);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return paymentGatewayMasterPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<PaymentGatewayMaster> getPaymentGatewayMasters(int start,
		int end) throws SystemException {
		return paymentGatewayMasterPersistence.findAll(start, end);
	}
	 ...
	 */
	@Override
	public int getPaymentGatewayMastersCount() throws SystemException {
		return paymentGatewayMasterPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public PaymentGatewayMaster updatePaymentGatewayMaster(
		PaymentGatewayMaster paymentGatewayMaster) throws SystemException {
		return paymentGatewayMasterPersistence.update(paymentGatewayMaster);
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("com.ifli.rapid.model.PaymentGatewayMaster",
			paymentGatewayMasterLocalService);
	}

	public void destroy() {
		PersistedModelLocalServiceRegistryUtil.unregister(
			"com.ifli.rapid.model.PaymentGatewayMaster");
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = paymentGatewayMasterPersistence.getDataSource();
	...
	private PaymentGatewayMasterLocalServiceClpInvoker _clpInvoker = new PaymentGatewayMasterLocalServiceClpInvoker();
}