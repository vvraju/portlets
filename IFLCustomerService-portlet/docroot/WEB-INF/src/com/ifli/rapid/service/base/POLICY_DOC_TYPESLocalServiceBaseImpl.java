...
import com.ifli.rapid.service.POLICY_DOC_TYPESLocalService;
...
/**
 * Provides the base implementation for the p o l i c y_ d o c_ t y p e s local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.ifli.rapid.service.impl.POLICY_DOC_TYPESLocalServiceImpl}.
 * </p>
 *
 * @author Satya Kola
 ...
 * @generated
 */
public abstract class POLICY_DOC_TYPESLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements POLICY_DOC_TYPESLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.ifli.rapid.service.POLICY_DOC_TYPESLocalServiceUtil} to access the p o l i c y_ d o c_ t y p e s local service.
	 */
	...
	@Override
	public POLICY_DOC_TYPES addPOLICY_DOC_TYPES(
		POLICY_DOC_TYPES policy_doc_types) throws SystemException {
		policy_doc_types.setNew(true);

		return policy_doc_typesPersistence.update(policy_doc_types);
	}
	 ...
	 */
	@Override
	public POLICY_DOC_TYPES createPOLICY_DOC_TYPES(int ID) {
		return policy_doc_typesPersistence.create(ID);
	}
	...
	@Override
	public POLICY_DOC_TYPES deletePOLICY_DOC_TYPES(int ID)
		throws PortalException, SystemException {
		return policy_doc_typesPersistence.remove(ID);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public POLICY_DOC_TYPES deletePOLICY_DOC_TYPES(
		POLICY_DOC_TYPES policy_doc_types) throws SystemException {
		return policy_doc_typesPersistence.remove(policy_doc_types);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(POLICY_DOC_TYPES.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		...
		return policy_doc_typesPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return policy_doc_typesPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public POLICY_DOC_TYPES fetchPOLICY_DOC_TYPES(int ID)
		throws SystemException {
		return policy_doc_typesPersistence.fetchByPrimaryKey(ID);
	}
	 ...
	 */
	@Override
	public POLICY_DOC_TYPES getPOLICY_DOC_TYPES(int ID)
		throws PortalException, SystemException {
		return policy_doc_typesPersistence.findByPrimaryKey(ID);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return policy_doc_typesPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<POLICY_DOC_TYPES> getPOLICY_DOC_TYPESs(int start, int end)
		throws SystemException {
		return policy_doc_typesPersistence.findAll(start, end);
	}
	 ...
	 */
	@Override
	public int getPOLICY_DOC_TYPESsCount() throws SystemException {
		return policy_doc_typesPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public POLICY_DOC_TYPES updatePOLICY_DOC_TYPES(
		POLICY_DOC_TYPES policy_doc_types) throws SystemException {
		return policy_doc_typesPersistence.update(policy_doc_types);
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("com.ifli.rapid.model.POLICY_DOC_TYPES",
			policy_doc_typesLocalService);
	}

	public void destroy() {
		PersistedModelLocalServiceRegistryUtil.unregister(
			"com.ifli.rapid.model.POLICY_DOC_TYPES");
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = policy_doc_typesPersistence.getDataSource();
	...
	private POLICY_DOC_TYPESLocalServiceClpInvoker _clpInvoker = new POLICY_DOC_TYPESLocalServiceClpInvoker();
}