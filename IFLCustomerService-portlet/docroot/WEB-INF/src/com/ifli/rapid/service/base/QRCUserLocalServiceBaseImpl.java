...
import com.ifli.rapid.service.QRCUserLocalService;
...
/**
 * Provides the base implementation for the q r c user local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.ifli.rapid.service.impl.QRCUserLocalServiceImpl}.
 * </p>
 *
 * @author Satya Kola
 * @see com.ifli.rapid.service.impl.QRCUserLocalServiceImpl
 * @see com.ifli.rapid.service.QRCUserLocalServiceUtil
 * @generated
 */
public abstract class QRCUserLocalServiceBaseImpl extends BaseLocalServiceImpl
	implements QRCUserLocalService, IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.ifli.rapid.service.QRCUserLocalServiceUtil} to access the q r c user local service.
	 */
	...
	@Override
	public QRCUser addQRCUser(QRCUser qrcUser) throws SystemException {
		qrcUser.setNew(true);

		return qrcUserPersistence.update(qrcUser);
	}
	 ...
	 */
	@Override
	public QRCUser createQRCUser(int QRC_USER_ID) {
		return qrcUserPersistence.create(QRC_USER_ID);
	}
	...
	@Override
	public QRCUser deleteQRCUser(int QRC_USER_ID)
		throws PortalException, SystemException {
		return qrcUserPersistence.remove(QRC_USER_ID);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public QRCUser deleteQRCUser(QRCUser qrcUser) throws SystemException {
		return qrcUserPersistence.remove(qrcUser);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(QRCUser.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		...
		return qrcUserPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public List dynamicQuery(DynamicQuery dynamicQuery, int start, int end)
		throws SystemException {
		return qrcUserPersistence.findWithDynamicQuery(dynamicQuery, start, end);
	}
	...
	public List dynamicQuery(DynamicQuery dynamicQuery, int start, int end,
		...
		return qrcUserPersistence.findWithDynamicQuery(dynamicQuery, start,
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return qrcUserPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery,
		...
		return qrcUserPersistence.countWithDynamicQuery(dynamicQuery, projection);
	}

	@Override
	public QRCUser fetchQRCUser(int QRC_USER_ID) throws SystemException {
		return qrcUserPersistence.fetchByPrimaryKey(QRC_USER_ID);
	}
	 ...
	 */
	@Override
	public QRCUser getQRCUser(int QRC_USER_ID)
		throws PortalException, SystemException {
		return qrcUserPersistence.findByPrimaryKey(QRC_USER_ID);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return qrcUserPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<QRCUser> getQRCUsers(int start, int end)
		throws SystemException {
		return qrcUserPersistence.findAll(start, end);
	}
	 ...
	 */
	@Override
	public int getQRCUsersCount() throws SystemException {
		return qrcUserPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public QRCUser updateQRCUser(QRCUser qrcUser) throws SystemException {
		return qrcUserPersistence.update(qrcUser);
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("com.ifli.rapid.model.QRCUser",
			qrcUserLocalService);
	}

	public void destroy() {
		PersistedModelLocalServiceRegistryUtil.unregister(
			"com.ifli.rapid.model.QRCUser");
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = qrcUserPersistence.getDataSource();
	...
	private QRCUserLocalServiceClpInvoker _clpInvoker = new QRCUserLocalServiceClpInvoker();
}