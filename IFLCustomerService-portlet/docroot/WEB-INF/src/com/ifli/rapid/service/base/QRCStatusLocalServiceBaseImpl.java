...
import com.ifli.rapid.service.QRCStatusLocalService;
...
/**
 * Provides the base implementation for the q r c status local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.ifli.rapid.service.impl.QRCStatusLocalServiceImpl}.
 * </p>
 *
 * @author Satya Kola
 ...
 * @generated
 */
public abstract class QRCStatusLocalServiceBaseImpl extends BaseLocalServiceImpl
	implements QRCStatusLocalService, IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.ifli.rapid.service.QRCStatusLocalServiceUtil} to access the q r c status local service.
	 */
	...
	@Override
	public QRCStatus addQRCStatus(QRCStatus qrcStatus)
		throws SystemException {
		qrcStatus.setNew(true);

		return qrcStatusPersistence.update(qrcStatus);
	}
	 ...
	 */
	@Override
	public QRCStatus createQRCStatus(int QRC_STATUS_ID) {
		return qrcStatusPersistence.create(QRC_STATUS_ID);
	}
	...
	@Override
	public QRCStatus deleteQRCStatus(int QRC_STATUS_ID)
		throws PortalException, SystemException {
		return qrcStatusPersistence.remove(QRC_STATUS_ID);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public QRCStatus deleteQRCStatus(QRCStatus qrcStatus)
		throws SystemException {
		return qrcStatusPersistence.remove(qrcStatus);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(QRCStatus.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		throws SystemException {
		return qrcStatusPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public List dynamicQuery(DynamicQuery dynamicQuery, int start, int end)
		throws SystemException {
		return qrcStatusPersistence.findWithDynamicQuery(dynamicQuery, start,
			end);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return qrcStatusPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public QRCStatus fetchQRCStatus(int QRC_STATUS_ID)
		throws SystemException {
		return qrcStatusPersistence.fetchByPrimaryKey(QRC_STATUS_ID);
	}
	 ...
	 */
	@Override
	public QRCStatus getQRCStatus(int QRC_STATUS_ID)
		throws PortalException, SystemException {
		return qrcStatusPersistence.findByPrimaryKey(QRC_STATUS_ID);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return qrcStatusPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<QRCStatus> getQRCStatuses(int start, int end)
		throws SystemException {
		return qrcStatusPersistence.findAll(start, end);
	}
	 ...
	 */
	@Override
	public int getQRCStatusesCount() throws SystemException {
		return qrcStatusPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public QRCStatus updateQRCStatus(QRCStatus qrcStatus)
		throws SystemException {
		return qrcStatusPersistence.update(qrcStatus);
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("com.ifli.rapid.model.QRCStatus",
			qrcStatusLocalService);
	}

	public void destroy() {
		PersistedModelLocalServiceRegistryUtil.unregister(
			"com.ifli.rapid.model.QRCStatus");
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = qrcStatusPersistence.getDataSource();
	...
	private QRCStatusLocalServiceClpInvoker _clpInvoker = new QRCStatusLocalServiceClpInvoker();
}