...
import com.ifli.rapid.service.AddressChangeReqDetailsLocalService;
...
/**
 * Provides the base implementation for the address change req details local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.ifli.rapid.service.impl.AddressChangeReqDetailsLocalServiceImpl}.
 * </p>
 *
 * @author Satya Kola
 * @see com.ifli.rapid.service.impl.AddressChangeReqDetailsLocalServiceImpl
 * @see com.ifli.rapid.service.AddressChangeReqDetailsLocalServiceUtil
 * @generated
 */
public abstract class AddressChangeReqDetailsLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements AddressChangeReqDetailsLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.ifli.rapid.service.AddressChangeReqDetailsLocalServiceUtil} to access the address change req details local service.
	 */
	...
	@Override
	public AddressChangeReqDetails addAddressChangeReqDetails(
		AddressChangeReqDetails addressChangeReqDetails)
		throws SystemException {
		addressChangeReqDetails.setNew(true);

		return addressChangeReqDetailsPersistence.update(addressChangeReqDetails);
	}
	 ...
	 */
	@Override
	public AddressChangeReqDetails createAddressChangeReqDetails(
		int ADDR_CHANGE_DETAILS_ID) {
		return addressChangeReqDetailsPersistence.create(ADDR_CHANGE_DETAILS_ID);
	}
	...
	@Override
	public AddressChangeReqDetails deleteAddressChangeReqDetails(
		int ADDR_CHANGE_DETAILS_ID) throws PortalException, SystemException {
		return addressChangeReqDetailsPersistence.remove(ADDR_CHANGE_DETAILS_ID);
	}
	...
	public AddressChangeReqDetails deleteAddressChangeReqDetails(
		AddressChangeReqDetails addressChangeReqDetails)
		throws SystemException {
		return addressChangeReqDetailsPersistence.remove(addressChangeReqDetails);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(AddressChangeReqDetails.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		throws SystemException {
		return addressChangeReqDetailsPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return addressChangeReqDetailsPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public AddressChangeReqDetails fetchAddressChangeReqDetails(
		int ADDR_CHANGE_DETAILS_ID) throws SystemException {
		return addressChangeReqDetailsPersistence.fetchByPrimaryKey(ADDR_CHANGE_DETAILS_ID);
	}
	 ...
	 */
	@Override
	public AddressChangeReqDetails getAddressChangeReqDetails(
		int ADDR_CHANGE_DETAILS_ID) throws PortalException, SystemException {
		return addressChangeReqDetailsPersistence.findByPrimaryKey(ADDR_CHANGE_DETAILS_ID);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return addressChangeReqDetailsPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<AddressChangeReqDetails> getAddressChangeReqDetailses(
		int start, int end) throws SystemException {
		return addressChangeReqDetailsPersistence.findAll(start, end);
	}
	 ...
	 */
	@Override
	public int getAddressChangeReqDetailsesCount() throws SystemException {
		return addressChangeReqDetailsPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public AddressChangeReqDetails updateAddressChangeReqDetails(
		AddressChangeReqDetails addressChangeReqDetails)
		throws SystemException {
		return addressChangeReqDetailsPersistence.update(addressChangeReqDetails);
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("com.ifli.rapid.model.AddressChangeReqDetails",
			addressChangeReqDetailsLocalService);
	}

	public void destroy() {
		PersistedModelLocalServiceRegistryUtil.unregister(
			"com.ifli.rapid.model.AddressChangeReqDetails");
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = addressChangeReqDetailsPersistence.getDataSource();
	...
	private AddressChangeReqDetailsLocalServiceClpInvoker _clpInvoker = new AddressChangeReqDetailsLocalServiceClpInvoker();
}