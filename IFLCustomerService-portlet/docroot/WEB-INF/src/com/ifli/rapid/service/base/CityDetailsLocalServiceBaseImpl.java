...
import com.ifli.rapid.service.CityDetailsLocalService;
...
/**
 * Provides the base implementation for the city details local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.ifli.rapid.service.impl.CityDetailsLocalServiceImpl}.
 * </p>
 *
 * @author Satya Kola
 * @see com.ifli.rapid.service.impl.CityDetailsLocalServiceImpl
 * @see com.ifli.rapid.service.CityDetailsLocalServiceUtil
 * @generated
 */
public abstract class CityDetailsLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements CityDetailsLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.ifli.rapid.service.CityDetailsLocalServiceUtil} to access the city details local service.
	 */
	...
	public CityDetails addCityDetails(CityDetails cityDetails)
		...
		return cityDetailsPersistence.update(cityDetails);
	}
	 ...
	 */
	@Override
	public CityDetails createCityDetails(int CITY_ID) {
		return cityDetailsPersistence.create(CITY_ID);
	}
	...
	@Override
	public CityDetails deleteCityDetails(int CITY_ID)
		throws PortalException, SystemException {
		return cityDetailsPersistence.remove(CITY_ID);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public CityDetails deleteCityDetails(CityDetails cityDetails)
		throws SystemException {
		return cityDetailsPersistence.remove(cityDetails);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(CityDetails.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		throws SystemException {
		return cityDetailsPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public List dynamicQuery(DynamicQuery dynamicQuery, int start, int end)
		throws SystemException {
		return cityDetailsPersistence.findWithDynamicQuery(dynamicQuery, start,
			end);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return cityDetailsPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public CityDetails fetchCityDetails(int CITY_ID) throws SystemException {
		return cityDetailsPersistence.fetchByPrimaryKey(CITY_ID);
	}
	 ...
	 */
	@Override
	public CityDetails getCityDetails(int CITY_ID)
		throws PortalException, SystemException {
		return cityDetailsPersistence.findByPrimaryKey(CITY_ID);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return cityDetailsPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<CityDetails> getCityDetailses(int start, int end)
		throws SystemException {
		return cityDetailsPersistence.findAll(start, end);
	}
	 ...
	 */
	@Override
	public int getCityDetailsesCount() throws SystemException {
		return cityDetailsPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public CityDetails updateCityDetails(CityDetails cityDetails)
		throws SystemException {
		return cityDetailsPersistence.update(cityDetails);
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("com.ifli.rapid.model.CityDetails",
			cityDetailsLocalService);
	}

	public void destroy() {
		PersistedModelLocalServiceRegistryUtil.unregister(
			"com.ifli.rapid.model.CityDetails");
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = cityDetailsPersistence.getDataSource();
	...
	private CityDetailsLocalServiceClpInvoker _clpInvoker = new CityDetailsLocalServiceClpInvoker();
}