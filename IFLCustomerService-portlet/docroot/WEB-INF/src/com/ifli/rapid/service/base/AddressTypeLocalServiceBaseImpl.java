...
import com.ifli.rapid.service.AddressTypeLocalService;
...
/**
 * Provides the base implementation for the address type local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.ifli.rapid.service.impl.AddressTypeLocalServiceImpl}.
 * </p>
 *
 * @author Satya Kola
 * @see com.ifli.rapid.service.impl.AddressTypeLocalServiceImpl
 * @see com.ifli.rapid.service.AddressTypeLocalServiceUtil
 * @generated
 */
public abstract class AddressTypeLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements AddressTypeLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.ifli.rapid.service.AddressTypeLocalServiceUtil} to access the address type local service.
	 */
	...
	public AddressType addAddressType(AddressType addressType)
		...
		return addressTypePersistence.update(addressType);
	}
	 ...
	 */
	@Override
	public AddressType createAddressType(int ADDRESS_TYPE_ID) {
		return addressTypePersistence.create(ADDRESS_TYPE_ID);
	}
	...
	@Override
	public AddressType deleteAddressType(int ADDRESS_TYPE_ID)
		throws PortalException, SystemException {
		return addressTypePersistence.remove(ADDRESS_TYPE_ID);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public AddressType deleteAddressType(AddressType addressType)
		throws SystemException {
		return addressTypePersistence.remove(addressType);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(AddressType.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		throws SystemException {
		return addressTypePersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public List dynamicQuery(DynamicQuery dynamicQuery, int start, int end)
		throws SystemException {
		return addressTypePersistence.findWithDynamicQuery(dynamicQuery, start,
			end);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return addressTypePersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public AddressType fetchAddressType(int ADDRESS_TYPE_ID)
		throws SystemException {
		return addressTypePersistence.fetchByPrimaryKey(ADDRESS_TYPE_ID);
	}
	 ...
	 */
	@Override
	public AddressType getAddressType(int ADDRESS_TYPE_ID)
		throws PortalException, SystemException {
		return addressTypePersistence.findByPrimaryKey(ADDRESS_TYPE_ID);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return addressTypePersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<AddressType> getAddressTypes(int start, int end)
		throws SystemException {
		return addressTypePersistence.findAll(start, end);
	}
	 ...
	 */
	@Override
	public int getAddressTypesCount() throws SystemException {
		return addressTypePersistence.countAll();
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("com.ifli.rapid.model.AddressType",
			addressTypeLocalService);
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = addressTypePersistence.getDataSource();
	...
	private AddressTypeLocalServiceClpInvoker _clpInvoker = new AddressTypeLocalServiceClpInvoker();
}