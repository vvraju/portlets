...
import com.ifli.rapid.service.LocationDetailsLocalService;
...
/**
 * Provides the base implementation for the location details local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.ifli.rapid.service.impl.LocationDetailsLocalServiceImpl}.
 * </p>
 *
 * @author Satya Kola
 * @see com.ifli.rapid.service.impl.LocationDetailsLocalServiceImpl
 * @see com.ifli.rapid.service.LocationDetailsLocalServiceUtil
 * @generated
 */
public abstract class LocationDetailsLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements LocationDetailsLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.ifli.rapid.service.LocationDetailsLocalServiceUtil} to access the location details local service.
	 */
	...
	@Override
	public LocationDetails addLocationDetails(LocationDetails locationDetails)
		throws SystemException {
		locationDetails.setNew(true);

		return locationDetailsPersistence.update(locationDetails);
	}
	 ...
	 */
	@Override
	public LocationDetails createLocationDetails(int LOCATION_ID) {
		return locationDetailsPersistence.create(LOCATION_ID);
	}
	...
	@Override
	public LocationDetails deleteLocationDetails(int LOCATION_ID)
		throws PortalException, SystemException {
		return locationDetailsPersistence.remove(LOCATION_ID);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public LocationDetails deleteLocationDetails(
		LocationDetails locationDetails) throws SystemException {
		return locationDetailsPersistence.remove(locationDetails);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(LocationDetails.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		throws SystemException {
		return locationDetailsPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return locationDetailsPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public LocationDetails fetchLocationDetails(int LOCATION_ID)
		throws SystemException {
		return locationDetailsPersistence.fetchByPrimaryKey(LOCATION_ID);
	}
	 ...
	 */
	@Override
	public LocationDetails getLocationDetails(int LOCATION_ID)
		throws PortalException, SystemException {
		return locationDetailsPersistence.findByPrimaryKey(LOCATION_ID);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return locationDetailsPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<LocationDetails> getLocationDetailses(int start, int end)
		throws SystemException {
		return locationDetailsPersistence.findAll(start, end);
	}
	 ...
	 */
	@Override
	public int getLocationDetailsesCount() throws SystemException {
		return locationDetailsPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public LocationDetails updateLocationDetails(
		LocationDetails locationDetails) throws SystemException {
		return locationDetailsPersistence.update(locationDetails);
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("com.ifli.rapid.model.LocationDetails",
			locationDetailsLocalService);
	}

	public void destroy() {
		PersistedModelLocalServiceRegistryUtil.unregister(
			"com.ifli.rapid.model.LocationDetails");
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = locationDetailsPersistence.getDataSource();
	...
	private LocationDetailsLocalServiceClpInvoker _clpInvoker = new LocationDetailsLocalServiceClpInvoker();
}