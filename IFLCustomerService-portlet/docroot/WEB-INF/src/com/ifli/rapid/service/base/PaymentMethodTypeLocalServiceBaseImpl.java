...
import com.ifli.rapid.service.PaymentMethodTypeLocalService;
...
/**
 * Provides the base implementation for the payment method type local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.ifli.rapid.service.impl.PaymentMethodTypeLocalServiceImpl}.
 * </p>
 *
 * @author Satya Kola
 * @see com.ifli.rapid.service.impl.PaymentMethodTypeLocalServiceImpl
 * @see com.ifli.rapid.service.PaymentMethodTypeLocalServiceUtil
 * @generated
 */
public abstract class PaymentMethodTypeLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements PaymentMethodTypeLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.ifli.rapid.service.PaymentMethodTypeLocalServiceUtil} to access the payment method type local service.
	 */
	...
	@Override
	public PaymentMethodType addPaymentMethodType(
		PaymentMethodType paymentMethodType) throws SystemException {
		paymentMethodType.setNew(true);

		return paymentMethodTypePersistence.update(paymentMethodType);
	}
	 ...
	 */
	@Override
	public PaymentMethodType createPaymentMethodType(String Id) {
		return paymentMethodTypePersistence.create(Id);
	}
	...
	@Override
	public PaymentMethodType deletePaymentMethodType(String Id)
		throws PortalException, SystemException {
		return paymentMethodTypePersistence.remove(Id);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public PaymentMethodType deletePaymentMethodType(
		PaymentMethodType paymentMethodType) throws SystemException {
		return paymentMethodTypePersistence.remove(paymentMethodType);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(PaymentMethodType.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		...
		return paymentMethodTypePersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return paymentMethodTypePersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public PaymentMethodType fetchPaymentMethodType(String Id)
		throws SystemException {
		return paymentMethodTypePersistence.fetchByPrimaryKey(Id);
	}
	 ...
	 */
	@Override
	public PaymentMethodType getPaymentMethodType(String Id)
		throws PortalException, SystemException {
		return paymentMethodTypePersistence.findByPrimaryKey(Id);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return paymentMethodTypePersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<PaymentMethodType> getPaymentMethodTypes(int start, int end)
		throws SystemException {
		return paymentMethodTypePersistence.findAll(start, end);
	}
	 ...
	 */
	@Override
	public int getPaymentMethodTypesCount() throws SystemException {
		return paymentMethodTypePersistence.countAll();
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("com.ifli.rapid.model.PaymentMethodType",
			paymentMethodTypeLocalService);
	}

	public void destroy() {
		PersistedModelLocalServiceRegistryUtil.unregister(
			"com.ifli.rapid.model.PaymentMethodType");
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = paymentMethodTypePersistence.getDataSource();
	...
	private PaymentMethodTypeLocalServiceClpInvoker _clpInvoker = new PaymentMethodTypeLocalServiceClpInvoker();
}