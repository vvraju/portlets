...
import com.ifli.rapid.service.PolicyTopupDetailsLocalService;
...
/**
 * Provides the base implementation for the policy topup details local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.ifli.rapid.service.impl.PolicyTopupDetailsLocalServiceImpl}.
 * </p>
 *
 * @author Satya Kola
 * @see com.ifli.rapid.service.impl.PolicyTopupDetailsLocalServiceImpl
 * @see com.ifli.rapid.service.PolicyTopupDetailsLocalServiceUtil
 * @generated
 */
public abstract class PolicyTopupDetailsLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements PolicyTopupDetailsLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.ifli.rapid.service.PolicyTopupDetailsLocalServiceUtil} to access the policy topup details local service.
	 */
	...
	@Override
	public PolicyTopupDetails addPolicyTopupDetails(
		PolicyTopupDetails policyTopupDetails) throws SystemException {
		policyTopupDetails.setNew(true);

		return policyTopupDetailsPersistence.update(policyTopupDetails);
	}
	 ...
	 */
	@Override
	public PolicyTopupDetails createPolicyTopupDetails(int TOPUP_ID) {
		return policyTopupDetailsPersistence.create(TOPUP_ID);
	}
	...
	@Override
	public PolicyTopupDetails deletePolicyTopupDetails(int TOPUP_ID)
		throws PortalException, SystemException {
		return policyTopupDetailsPersistence.remove(TOPUP_ID);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public PolicyTopupDetails deletePolicyTopupDetails(
		PolicyTopupDetails policyTopupDetails) throws SystemException {
		return policyTopupDetailsPersistence.remove(policyTopupDetails);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(PolicyTopupDetails.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		...
		return policyTopupDetailsPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return policyTopupDetailsPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public PolicyTopupDetails fetchPolicyTopupDetails(int TOPUP_ID)
		throws SystemException {
		return policyTopupDetailsPersistence.fetchByPrimaryKey(TOPUP_ID);
	}
	 ...
	 */
	@Override
	public PolicyTopupDetails getPolicyTopupDetails(int TOPUP_ID)
		throws PortalException, SystemException {
		return policyTopupDetailsPersistence.findByPrimaryKey(TOPUP_ID);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return policyTopupDetailsPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<PolicyTopupDetails> getPolicyTopupDetailses(int start, int end)
		throws SystemException {
		return policyTopupDetailsPersistence.findAll(start, end);
	}
	 ...
	 */
	@Override
	public int getPolicyTopupDetailsesCount() throws SystemException {
		return policyTopupDetailsPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public PolicyTopupDetails updatePolicyTopupDetails(
		PolicyTopupDetails policyTopupDetails) throws SystemException {
		return policyTopupDetailsPersistence.update(policyTopupDetails);
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("com.ifli.rapid.model.PolicyTopupDetails",
			policyTopupDetailsLocalService);
	}

	public void destroy() {
		PersistedModelLocalServiceRegistryUtil.unregister(
			"com.ifli.rapid.model.PolicyTopupDetails");
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = policyTopupDetailsPersistence.getDataSource();
	...
	private PolicyTopupDetailsLocalServiceClpInvoker _clpInvoker = new PolicyTopupDetailsLocalServiceClpInvoker();
}