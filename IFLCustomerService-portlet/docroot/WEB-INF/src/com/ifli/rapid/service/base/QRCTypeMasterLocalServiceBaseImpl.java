...
import com.ifli.rapid.service.QRCTypeMasterLocalService;
...
/**
 * Provides the base implementation for the q r c type master local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.ifli.rapid.service.impl.QRCTypeMasterLocalServiceImpl}.
 * </p>
 *
 * @author Satya Kola
 * @see com.ifli.rapid.service.impl.QRCTypeMasterLocalServiceImpl
 * @see com.ifli.rapid.service.QRCTypeMasterLocalServiceUtil
 * @generated
 */
public abstract class QRCTypeMasterLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements QRCTypeMasterLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.ifli.rapid.service.QRCTypeMasterLocalServiceUtil} to access the q r c type master local service.
	 */
	...
	@Override
	public QRCTypeMaster addQRCTypeMaster(QRCTypeMaster qrcTypeMaster)
		throws SystemException {
		qrcTypeMaster.setNew(true);

		return qrcTypeMasterPersistence.update(qrcTypeMaster);
	}
	 ...
	 */
	@Override
	public QRCTypeMaster createQRCTypeMaster(int QRC_TYPE_ID) {
		return qrcTypeMasterPersistence.create(QRC_TYPE_ID);
	}
	...
	@Override
	public QRCTypeMaster deleteQRCTypeMaster(int QRC_TYPE_ID)
		throws PortalException, SystemException {
		return qrcTypeMasterPersistence.remove(QRC_TYPE_ID);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public QRCTypeMaster deleteQRCTypeMaster(QRCTypeMaster qrcTypeMaster)
		throws SystemException {
		return qrcTypeMasterPersistence.remove(qrcTypeMaster);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(QRCTypeMaster.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		throws SystemException {
		return qrcTypeMasterPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return qrcTypeMasterPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public QRCTypeMaster fetchQRCTypeMaster(int QRC_TYPE_ID)
		throws SystemException {
		return qrcTypeMasterPersistence.fetchByPrimaryKey(QRC_TYPE_ID);
	}
	 ...
	 */
	@Override
	public QRCTypeMaster getQRCTypeMaster(int QRC_TYPE_ID)
		throws PortalException, SystemException {
		return qrcTypeMasterPersistence.findByPrimaryKey(QRC_TYPE_ID);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return qrcTypeMasterPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<QRCTypeMaster> getQRCTypeMasters(int start, int end)
		throws SystemException {
		return qrcTypeMasterPersistence.findAll(start, end);
	}
	 ...
	 */
	@Override
	public int getQRCTypeMastersCount() throws SystemException {
		return qrcTypeMasterPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public QRCTypeMaster updateQRCTypeMaster(QRCTypeMaster qrcTypeMaster)
		throws SystemException {
		return qrcTypeMasterPersistence.update(qrcTypeMaster);
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("com.ifli.rapid.model.QRCTypeMaster",
			qrcTypeMasterLocalService);
	}

	public void destroy() {
		PersistedModelLocalServiceRegistryUtil.unregister(
			"com.ifli.rapid.model.QRCTypeMaster");
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = qrcTypeMasterPersistence.getDataSource();
	...
	private QRCTypeMasterLocalServiceClpInvoker _clpInvoker = new QRCTypeMasterLocalServiceClpInvoker();
}