...
import com.ifli.rapid.service.PolicyInfoLocalService;
...
/**
 * Provides the base implementation for the policy info local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.ifli.rapid.service.impl.PolicyInfoLocalServiceImpl}.
 * </p>
 *
 * @author Satya Kola
 * @see com.ifli.rapid.service.impl.PolicyInfoLocalServiceImpl
 * @see com.ifli.rapid.service.PolicyInfoLocalServiceUtil
 * @generated
 */
public abstract class PolicyInfoLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements PolicyInfoLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.ifli.rapid.service.PolicyInfoLocalServiceUtil} to access the policy info local service.
	 */
	...
	@Override
	public PolicyInfo addPolicyInfo(PolicyInfo policyInfo)
		throws SystemException {
		policyInfo.setNew(true);

		return policyInfoPersistence.update(policyInfo);
	}
	 ...
	 */
	@Override
	public PolicyInfo createPolicyInfo(String POLICY_ID) {
		return policyInfoPersistence.create(POLICY_ID);
	}
	...
	@Override
	public PolicyInfo deletePolicyInfo(String POLICY_ID)
		throws PortalException, SystemException {
		return policyInfoPersistence.remove(POLICY_ID);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public PolicyInfo deletePolicyInfo(PolicyInfo policyInfo)
		throws SystemException {
		return policyInfoPersistence.remove(policyInfo);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(PolicyInfo.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		throws SystemException {
		return policyInfoPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public List dynamicQuery(DynamicQuery dynamicQuery, int start, int end)
		throws SystemException {
		return policyInfoPersistence.findWithDynamicQuery(dynamicQuery, start,
			end);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return policyInfoPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public PolicyInfo fetchPolicyInfo(String POLICY_ID)
		throws SystemException {
		return policyInfoPersistence.fetchByPrimaryKey(POLICY_ID);
	}
	 ...
	 */
	@Override
	public PolicyInfo getPolicyInfo(String POLICY_ID)
		throws PortalException, SystemException {
		return policyInfoPersistence.findByPrimaryKey(POLICY_ID);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return policyInfoPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<PolicyInfo> getPolicyInfos(int start, int end)
		throws SystemException {
		return policyInfoPersistence.findAll(start, end);
	}
	 ...
	 */
	@Override
	public int getPolicyInfosCount() throws SystemException {
		return policyInfoPersistence.countAll();
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("com.ifli.rapid.model.PolicyInfo",
			policyInfoLocalService);
	}

	public void destroy() {
		PersistedModelLocalServiceRegistryUtil.unregister(
			"com.ifli.rapid.model.PolicyInfo");
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = policyInfoPersistence.getDataSource();
	...
	private PolicyInfoLocalServiceClpInvoker _clpInvoker = new PolicyInfoLocalServiceClpInvoker();
}