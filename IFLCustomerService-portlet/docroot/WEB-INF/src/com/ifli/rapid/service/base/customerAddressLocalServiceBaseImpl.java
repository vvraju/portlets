...
import com.ifli.rapid.service.customerAddressLocalService;
...
/**
 * Provides the base implementation for the customer address local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.ifli.rapid.service.impl.customerAddressLocalServiceImpl}.
 * </p>
 *
 * @author Satya Kola
 * @see com.ifli.rapid.service.impl.customerAddressLocalServiceImpl
 * @see com.ifli.rapid.service.customerAddressLocalServiceUtil
 * @generated
 */
public abstract class customerAddressLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements customerAddressLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.ifli.rapid.service.customerAddressLocalServiceUtil} to access the customer address local service.
	 */
	...
	public customerAddress addcustomerAddress(customerAddress customerAddress)
		...
		return customerAddressPersistence.update(customerAddress);
	}
	 ...
	 */
	@Override
	public customerAddress createcustomerAddress(int CUSTOMER_ADDRESS_ID) {
		return customerAddressPersistence.create(CUSTOMER_ADDRESS_ID);
	}
	...
	@Override
	public customerAddress deletecustomerAddress(int CUSTOMER_ADDRESS_ID)
		throws PortalException, SystemException {
		return customerAddressPersistence.remove(CUSTOMER_ADDRESS_ID);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public customerAddress deletecustomerAddress(
		customerAddress customerAddress) throws SystemException {
		return customerAddressPersistence.remove(customerAddress);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(customerAddress.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		throws SystemException {
		return customerAddressPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return customerAddressPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public customerAddress fetchcustomerAddress(int CUSTOMER_ADDRESS_ID)
		throws SystemException {
		return customerAddressPersistence.fetchByPrimaryKey(CUSTOMER_ADDRESS_ID);
	}
	 ...
	 */
	@Override
	public customerAddress getcustomerAddress(int CUSTOMER_ADDRESS_ID)
		throws PortalException, SystemException {
		return customerAddressPersistence.findByPrimaryKey(CUSTOMER_ADDRESS_ID);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return customerAddressPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<customerAddress> getcustomerAddresses(int start, int end)
		throws SystemException {
		return customerAddressPersistence.findAll(start, end);
	}
	 ...
	 */
	@Override
	public int getcustomerAddressesCount() throws SystemException {
		return customerAddressPersistence.countAll();
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("com.ifli.rapid.model.customerAddress",
			customerAddressLocalService);
	}

	public void destroy() {
		PersistedModelLocalServiceRegistryUtil.unregister(
			"com.ifli.rapid.model.customerAddress");
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = customerAddressPersistence.getDataSource();
	...
	private customerAddressLocalServiceClpInvoker _clpInvoker = new customerAddressLocalServiceClpInvoker();
}