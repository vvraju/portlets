...
import com.ifli.rapid.service.CustomerMobileNumbersLocalService;
...
/**
 * Provides the base implementation for the customer mobile numbers local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.ifli.rapid.service.impl.CustomerMobileNumbersLocalServiceImpl}.
 * </p>
 *
 * @author Satya Kola
 * @see com.ifli.rapid.service.impl.CustomerMobileNumbersLocalServiceImpl
 * @see com.ifli.rapid.service.CustomerMobileNumbersLocalServiceUtil
 * @generated
 */
public abstract class CustomerMobileNumbersLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements CustomerMobileNumbersLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.ifli.rapid.service.CustomerMobileNumbersLocalServiceUtil} to access the customer mobile numbers local service.
	 */
	...
	@Override
	public CustomerMobileNumbers addCustomerMobileNumbers(
		CustomerMobileNumbers customerMobileNumbers) throws SystemException {
		customerMobileNumbers.setNew(true);

		return customerMobileNumbersPersistence.update(customerMobileNumbers);
	}
	 ...
	 */
	@Override
	public CustomerMobileNumbers createCustomerMobileNumbers(int ID) {
		return customerMobileNumbersPersistence.create(ID);
	}
	...
	@Override
	public CustomerMobileNumbers deleteCustomerMobileNumbers(int ID)
		throws PortalException, SystemException {
		return customerMobileNumbersPersistence.remove(ID);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public CustomerMobileNumbers deleteCustomerMobileNumbers(
		CustomerMobileNumbers customerMobileNumbers) throws SystemException {
		return customerMobileNumbersPersistence.remove(customerMobileNumbers);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(CustomerMobileNumbers.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		...
		return customerMobileNumbersPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return customerMobileNumbersPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public CustomerMobileNumbers fetchCustomerMobileNumbers(int ID)
		throws SystemException {
		return customerMobileNumbersPersistence.fetchByPrimaryKey(ID);
	}
	 ...
	 */
	@Override
	public CustomerMobileNumbers getCustomerMobileNumbers(int ID)
		throws PortalException, SystemException {
		return customerMobileNumbersPersistence.findByPrimaryKey(ID);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return customerMobileNumbersPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<CustomerMobileNumbers> getCustomerMobileNumberses(int start,
		int end) throws SystemException {
		return customerMobileNumbersPersistence.findAll(start, end);
	}
	 ...
	 */
	@Override
	public int getCustomerMobileNumbersesCount() throws SystemException {
		return customerMobileNumbersPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public CustomerMobileNumbers updateCustomerMobileNumbers(
		CustomerMobileNumbers customerMobileNumbers) throws SystemException {
		return customerMobileNumbersPersistence.update(customerMobileNumbers);
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("com.ifli.rapid.model.CustomerMobileNumbers",
			customerMobileNumbersLocalService);
	}

	public void destroy() {
		PersistedModelLocalServiceRegistryUtil.unregister(
			"com.ifli.rapid.model.CustomerMobileNumbers");
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = customerMobileNumbersPersistence.getDataSource();
	...
	private CustomerMobileNumbersLocalServiceClpInvoker _clpInvoker = new CustomerMobileNumbersLocalServiceClpInvoker();
}