...
import com.ifli.rapid.service.TempCustomerAddressLocalService;
...
/**
 * Provides the base implementation for the temp customer address local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.ifli.rapid.service.impl.TempCustomerAddressLocalServiceImpl}.
 * </p>
 *
 * @author Satya Kola
 * @see com.ifli.rapid.service.impl.TempCustomerAddressLocalServiceImpl
 * @see com.ifli.rapid.service.TempCustomerAddressLocalServiceUtil
 * @generated
 */
public abstract class TempCustomerAddressLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements TempCustomerAddressLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.ifli.rapid.service.TempCustomerAddressLocalServiceUtil} to access the temp customer address local service.
	 */
	...
	@Override
	public TempCustomerAddress addTempCustomerAddress(
		TempCustomerAddress tempCustomerAddress) throws SystemException {
		tempCustomerAddress.setNew(true);

		return tempCustomerAddressPersistence.update(tempCustomerAddress);
	}
	 ...
	 */
	@Override
	public TempCustomerAddress createTempCustomerAddress(
		int CUSTOMER_ADDRESS_ID) {
		return tempCustomerAddressPersistence.create(CUSTOMER_ADDRESS_ID);
	}
	...
	@Override
	public TempCustomerAddress deleteTempCustomerAddress(
		int CUSTOMER_ADDRESS_ID) throws PortalException, SystemException {
		return tempCustomerAddressPersistence.remove(CUSTOMER_ADDRESS_ID);
	}
	...
	public TempCustomerAddress deleteTempCustomerAddress(
		TempCustomerAddress tempCustomerAddress) throws SystemException {
		return tempCustomerAddressPersistence.remove(tempCustomerAddress);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(TempCustomerAddress.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		...
		return tempCustomerAddressPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return tempCustomerAddressPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public TempCustomerAddress fetchTempCustomerAddress(int CUSTOMER_ADDRESS_ID)
		throws SystemException {
		return tempCustomerAddressPersistence.fetchByPrimaryKey(CUSTOMER_ADDRESS_ID);
	}
	 ...
	 */
	@Override
	public TempCustomerAddress getTempCustomerAddress(int CUSTOMER_ADDRESS_ID)
		throws PortalException, SystemException {
		return tempCustomerAddressPersistence.findByPrimaryKey(CUSTOMER_ADDRESS_ID);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return tempCustomerAddressPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<TempCustomerAddress> getTempCustomerAddresses(int start, int end)
		throws SystemException {
		return tempCustomerAddressPersistence.findAll(start, end);
	}
	 ...
	 */
	@Override
	public int getTempCustomerAddressesCount() throws SystemException {
		return tempCustomerAddressPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public TempCustomerAddress updateTempCustomerAddress(
		TempCustomerAddress tempCustomerAddress) throws SystemException {
		return tempCustomerAddressPersistence.update(tempCustomerAddress);
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("com.ifli.rapid.model.TempCustomerAddress",
			tempCustomerAddressLocalService);
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = tempCustomerAddressPersistence.getDataSource();
	...
	private TempCustomerAddressLocalServiceClpInvoker _clpInvoker = new TempCustomerAddressLocalServiceClpInvoker();
}