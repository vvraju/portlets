...
import com.ifli.rapid.service.PremiumFrequencyMasterLocalService;
...
/**
 * Provides the base implementation for the premium frequency master local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.ifli.rapid.service.impl.PremiumFrequencyMasterLocalServiceImpl}.
 * </p>
 *
 * @author Satya Kola
 * @see com.ifli.rapid.service.impl.PremiumFrequencyMasterLocalServiceImpl
 * @see com.ifli.rapid.service.PremiumFrequencyMasterLocalServiceUtil
 * @generated
 */
public abstract class PremiumFrequencyMasterLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements PremiumFrequencyMasterLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.ifli.rapid.service.PremiumFrequencyMasterLocalServiceUtil} to access the premium frequency master local service.
	 */
	...
	@Override
	public PremiumFrequencyMaster addPremiumFrequencyMaster(
		PremiumFrequencyMaster premiumFrequencyMaster)
		throws SystemException {
		premiumFrequencyMaster.setNew(true);

		return premiumFrequencyMasterPersistence.update(premiumFrequencyMaster);
	}
	 ...
	 */
	@Override
	public PremiumFrequencyMaster createPremiumFrequencyMaster(
		String PremiumFrequencyId) {
		return premiumFrequencyMasterPersistence.create(PremiumFrequencyId);
	}
	...
	@Override
	public PremiumFrequencyMaster deletePremiumFrequencyMaster(
		String PremiumFrequencyId) throws PortalException, SystemException {
		return premiumFrequencyMasterPersistence.remove(PremiumFrequencyId);
	}
	...
	public PremiumFrequencyMaster deletePremiumFrequencyMaster(
		PremiumFrequencyMaster premiumFrequencyMaster)
		throws SystemException {
		return premiumFrequencyMasterPersistence.remove(premiumFrequencyMaster);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(PremiumFrequencyMaster.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		throws SystemException {
		return premiumFrequencyMasterPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return premiumFrequencyMasterPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public PremiumFrequencyMaster fetchPremiumFrequencyMaster(
		String PremiumFrequencyId) throws SystemException {
		return premiumFrequencyMasterPersistence.fetchByPrimaryKey(PremiumFrequencyId);
	}
	 ...
	 */
	@Override
	public PremiumFrequencyMaster getPremiumFrequencyMaster(
		String PremiumFrequencyId) throws PortalException, SystemException {
		return premiumFrequencyMasterPersistence.findByPrimaryKey(PremiumFrequencyId);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return premiumFrequencyMasterPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<PremiumFrequencyMaster> getPremiumFrequencyMasters(int start,
		int end) throws SystemException {
		return premiumFrequencyMasterPersistence.findAll(start, end);
	}
	 ...
	 */
	@Override
	public int getPremiumFrequencyMastersCount() throws SystemException {
		return premiumFrequencyMasterPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public PremiumFrequencyMaster updatePremiumFrequencyMaster(
		PremiumFrequencyMaster premiumFrequencyMaster)
		throws SystemException {
		return premiumFrequencyMasterPersistence.update(premiumFrequencyMaster);
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("com.ifli.rapid.model.PremiumFrequencyMaster",
			premiumFrequencyMasterLocalService);
	}

	public void destroy() {
		PersistedModelLocalServiceRegistryUtil.unregister(
			"com.ifli.rapid.model.PremiumFrequencyMaster");
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = premiumFrequencyMasterPersistence.getDataSource();
	...
	private PremiumFrequencyMasterLocalServiceClpInvoker _clpInvoker = new PremiumFrequencyMasterLocalServiceClpInvoker();
}