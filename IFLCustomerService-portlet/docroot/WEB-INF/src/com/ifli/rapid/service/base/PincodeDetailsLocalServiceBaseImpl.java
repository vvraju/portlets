...
import com.ifli.rapid.service.PincodeDetailsLocalService;
...
/**
 * Provides the base implementation for the pincode details local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.ifli.rapid.service.impl.PincodeDetailsLocalServiceImpl}.
 * </p>
 *
 * @author Satya Kola
 * @see com.ifli.rapid.service.impl.PincodeDetailsLocalServiceImpl
 * @see com.ifli.rapid.service.PincodeDetailsLocalServiceUtil
 * @generated
 */
public abstract class PincodeDetailsLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements PincodeDetailsLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.ifli.rapid.service.PincodeDetailsLocalServiceUtil} to access the pincode details local service.
	 */
	...
	@Override
	public PincodeDetails addPincodeDetails(PincodeDetails pincodeDetails)
		throws SystemException {
		pincodeDetails.setNew(true);

		return pincodeDetailsPersistence.update(pincodeDetails);
	}
	 ...
	 */
	@Override
	public PincodeDetails createPincodeDetails(int PIN_ID) {
		return pincodeDetailsPersistence.create(PIN_ID);
	}
	...
	@Override
	public PincodeDetails deletePincodeDetails(int PIN_ID)
		throws PortalException, SystemException {
		return pincodeDetailsPersistence.remove(PIN_ID);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public PincodeDetails deletePincodeDetails(PincodeDetails pincodeDetails)
		throws SystemException {
		return pincodeDetailsPersistence.remove(pincodeDetails);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(PincodeDetails.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		throws SystemException {
		return pincodeDetailsPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return pincodeDetailsPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public PincodeDetails fetchPincodeDetails(int PIN_ID)
		throws SystemException {
		return pincodeDetailsPersistence.fetchByPrimaryKey(PIN_ID);
	}
	 ...
	 */
	@Override
	public PincodeDetails getPincodeDetails(int PIN_ID)
		throws PortalException, SystemException {
		return pincodeDetailsPersistence.findByPrimaryKey(PIN_ID);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return pincodeDetailsPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<PincodeDetails> getPincodeDetailses(int start, int end)
		throws SystemException {
		return pincodeDetailsPersistence.findAll(start, end);
	}
	 ...
	 */
	@Override
	public int getPincodeDetailsesCount() throws SystemException {
		return pincodeDetailsPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public PincodeDetails updatePincodeDetails(PincodeDetails pincodeDetails)
		throws SystemException {
		return pincodeDetailsPersistence.update(pincodeDetails);
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("com.ifli.rapid.model.PincodeDetails",
			pincodeDetailsLocalService);
	}

	public void destroy() {
		PersistedModelLocalServiceRegistryUtil.unregister(
			"com.ifli.rapid.model.PincodeDetails");
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = pincodeDetailsPersistence.getDataSource();
	...
	private PincodeDetailsLocalServiceClpInvoker _clpInvoker = new PincodeDetailsLocalServiceClpInvoker();
}