...
import com.ifli.rapid.service.Recommended_ProductsLocalService;
...
/**
 * Provides the base implementation for the recommended_ products local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.ifli.rapid.service.impl.Recommended_ProductsLocalServiceImpl}.
 * </p>
 *
 * @author Satya Kola
 * @see com.ifli.rapid.service.impl.Recommended_ProductsLocalServiceImpl
 * @see com.ifli.rapid.service.Recommended_ProductsLocalServiceUtil
 * @generated
 */
public abstract class Recommended_ProductsLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements Recommended_ProductsLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.ifli.rapid.service.Recommended_ProductsLocalServiceUtil} to access the recommended_ products local service.
	 */
	...
	@Override
	public Recommended_Products addRecommended_Products(
		Recommended_Products recommended_Products) throws SystemException {
		recommended_Products.setNew(true);

		return recommended_ProductsPersistence.update(recommended_Products);
	}
	 ...
	 */
	@Override
	public Recommended_Products createRecommended_Products(int PRODUCT_ID) {
		return recommended_ProductsPersistence.create(PRODUCT_ID);
	}
	...
	@Override
	public Recommended_Products deleteRecommended_Products(int PRODUCT_ID)
		throws PortalException, SystemException {
		return recommended_ProductsPersistence.remove(PRODUCT_ID);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public Recommended_Products deleteRecommended_Products(
		Recommended_Products recommended_Products) throws SystemException {
		return recommended_ProductsPersistence.remove(recommended_Products);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(Recommended_Products.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		...
		return recommended_ProductsPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return recommended_ProductsPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public Recommended_Products fetchRecommended_Products(int PRODUCT_ID)
		throws SystemException {
		return recommended_ProductsPersistence.fetchByPrimaryKey(PRODUCT_ID);
	}
	 ...
	 */
	@Override
	public Recommended_Products getRecommended_Products(int PRODUCT_ID)
		throws PortalException, SystemException {
		return recommended_ProductsPersistence.findByPrimaryKey(PRODUCT_ID);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return recommended_ProductsPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<Recommended_Products> getRecommended_Productses(int start,
		int end) throws SystemException {
		return recommended_ProductsPersistence.findAll(start, end);
	}
	 ...
	 */
	@Override
	public int getRecommended_ProductsesCount() throws SystemException {
		return recommended_ProductsPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public Recommended_Products updateRecommended_Products(
		Recommended_Products recommended_Products) throws SystemException {
		return recommended_ProductsPersistence.update(recommended_Products);
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("com.ifli.rapid.model.Recommended_Products",
			recommended_ProductsLocalService);
	}

	public void destroy() {
		PersistedModelLocalServiceRegistryUtil.unregister(
			"com.ifli.rapid.model.Recommended_Products");
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = recommended_ProductsPersistence.getDataSource();
	...
	private Recommended_ProductsLocalServiceClpInvoker _clpInvoker = new Recommended_ProductsLocalServiceClpInvoker();
}