...
import com.ifli.rapid.service.CustomerFamilyDetailsLocalService;
...
/**
 * Provides the base implementation for the customer family details local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.ifli.rapid.service.impl.CustomerFamilyDetailsLocalServiceImpl}.
 * </p>
 *
 * @author Satya Kola
 * @see com.ifli.rapid.service.impl.CustomerFamilyDetailsLocalServiceImpl
 * @see com.ifli.rapid.service.CustomerFamilyDetailsLocalServiceUtil
 * @generated
 */
public abstract class CustomerFamilyDetailsLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements CustomerFamilyDetailsLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.ifli.rapid.service.CustomerFamilyDetailsLocalServiceUtil} to access the customer family details local service.
	 */
	...
	@Override
	public CustomerFamilyDetails addCustomerFamilyDetails(
		CustomerFamilyDetails customerFamilyDetails) throws SystemException {
		customerFamilyDetails.setNew(true);

		return customerFamilyDetailsPersistence.update(customerFamilyDetails);
	}
	 ...
	 */
	@Override
	public CustomerFamilyDetails createCustomerFamilyDetails(
		int CUSTOMER_FAMILY_ID) {
		return customerFamilyDetailsPersistence.create(CUSTOMER_FAMILY_ID);
	}
	...
	@Override
	public CustomerFamilyDetails deleteCustomerFamilyDetails(
		int CUSTOMER_FAMILY_ID) throws PortalException, SystemException {
		return customerFamilyDetailsPersistence.remove(CUSTOMER_FAMILY_ID);
	}
	...
	public CustomerFamilyDetails deleteCustomerFamilyDetails(
		CustomerFamilyDetails customerFamilyDetails) throws SystemException {
		return customerFamilyDetailsPersistence.remove(customerFamilyDetails);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(CustomerFamilyDetails.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		...
		return customerFamilyDetailsPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return customerFamilyDetailsPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public CustomerFamilyDetails fetchCustomerFamilyDetails(
		int CUSTOMER_FAMILY_ID) throws SystemException {
		return customerFamilyDetailsPersistence.fetchByPrimaryKey(CUSTOMER_FAMILY_ID);
	}
	 ...
	 */
	@Override
	public CustomerFamilyDetails getCustomerFamilyDetails(
		int CUSTOMER_FAMILY_ID) throws PortalException, SystemException {
		return customerFamilyDetailsPersistence.findByPrimaryKey(CUSTOMER_FAMILY_ID);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return customerFamilyDetailsPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<CustomerFamilyDetails> getCustomerFamilyDetailses(int start,
		int end) throws SystemException {
		return customerFamilyDetailsPersistence.findAll(start, end);
	}
	 ...
	 */
	@Override
	public int getCustomerFamilyDetailsesCount() throws SystemException {
		return customerFamilyDetailsPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public CustomerFamilyDetails updateCustomerFamilyDetails(
		CustomerFamilyDetails customerFamilyDetails) throws SystemException {
		return customerFamilyDetailsPersistence.update(customerFamilyDetails);
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("com.ifli.rapid.model.CustomerFamilyDetails",
			customerFamilyDetailsLocalService);
	}

	public void destroy() {
		PersistedModelLocalServiceRegistryUtil.unregister(
			"com.ifli.rapid.model.CustomerFamilyDetails");
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = customerFamilyDetailsPersistence.getDataSource();
	...
	private CustomerFamilyDetailsLocalServiceClpInvoker _clpInvoker = new CustomerFamilyDetailsLocalServiceClpInvoker();
}