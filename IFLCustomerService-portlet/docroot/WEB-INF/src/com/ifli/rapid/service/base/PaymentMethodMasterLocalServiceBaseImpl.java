...
import com.ifli.rapid.service.PaymentMethodMasterLocalService;
...
/**
 * Provides the base implementation for the payment method master local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.ifli.rapid.service.impl.PaymentMethodMasterLocalServiceImpl}.
 * </p>
 *
 * @author Satya Kola
 * @see com.ifli.rapid.service.impl.PaymentMethodMasterLocalServiceImpl
 * @see com.ifli.rapid.service.PaymentMethodMasterLocalServiceUtil
 * @generated
 */
public abstract class PaymentMethodMasterLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements PaymentMethodMasterLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.ifli.rapid.service.PaymentMethodMasterLocalServiceUtil} to access the payment method master local service.
	 */
	...
	@Override
	public PaymentMethodMaster addPaymentMethodMaster(
		PaymentMethodMaster paymentMethodMaster) throws SystemException {
		paymentMethodMaster.setNew(true);

		return paymentMethodMasterPersistence.update(paymentMethodMaster);
	}
	 ...
	 */
	@Override
	public PaymentMethodMaster createPaymentMethodMaster(String PaymentMethodID) {
		return paymentMethodMasterPersistence.create(PaymentMethodID);
	}
	...
	@Override
	public PaymentMethodMaster deletePaymentMethodMaster(String PaymentMethodID)
		throws PortalException, SystemException {
		return paymentMethodMasterPersistence.remove(PaymentMethodID);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public PaymentMethodMaster deletePaymentMethodMaster(
		PaymentMethodMaster paymentMethodMaster) throws SystemException {
		return paymentMethodMasterPersistence.remove(paymentMethodMaster);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(PaymentMethodMaster.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		...
		return paymentMethodMasterPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return paymentMethodMasterPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public PaymentMethodMaster fetchPaymentMethodMaster(String PaymentMethodID)
		throws SystemException {
		return paymentMethodMasterPersistence.fetchByPrimaryKey(PaymentMethodID);
	}
	 ...
	 */
	@Override
	public PaymentMethodMaster getPaymentMethodMaster(String PaymentMethodID)
		throws PortalException, SystemException {
		return paymentMethodMasterPersistence.findByPrimaryKey(PaymentMethodID);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return paymentMethodMasterPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<PaymentMethodMaster> getPaymentMethodMasters(int start, int end)
		throws SystemException {
		return paymentMethodMasterPersistence.findAll(start, end);
	}
	 ...
	 */
	@Override
	public int getPaymentMethodMastersCount() throws SystemException {
		return paymentMethodMasterPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public PaymentMethodMaster updatePaymentMethodMaster(
		PaymentMethodMaster paymentMethodMaster) throws SystemException {
		return paymentMethodMasterPersistence.update(paymentMethodMaster);
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("com.ifli.rapid.model.PaymentMethodMaster",
			paymentMethodMasterLocalService);
	}

	public void destroy() {
		PersistedModelLocalServiceRegistryUtil.unregister(
			"com.ifli.rapid.model.PaymentMethodMaster");
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = paymentMethodMasterPersistence.getDataSource();
	...
	private PaymentMethodMasterLocalServiceClpInvoker _clpInvoker = new PaymentMethodMasterLocalServiceClpInvoker();
}