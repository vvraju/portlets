...
import com.ifli.rapid.service.PaymentOptionMasterLocalService;
...
/**
 * Provides the base implementation for the payment option master local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.ifli.rapid.service.impl.PaymentOptionMasterLocalServiceImpl}.
 * </p>
 *
 * @author Satya Kola
 * @see com.ifli.rapid.service.impl.PaymentOptionMasterLocalServiceImpl
 * @see com.ifli.rapid.service.PaymentOptionMasterLocalServiceUtil
 * @generated
 */
public abstract class PaymentOptionMasterLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements PaymentOptionMasterLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.ifli.rapid.service.PaymentOptionMasterLocalServiceUtil} to access the payment option master local service.
	 */
	...
	@Override
	public PaymentOptionMaster addPaymentOptionMaster(
		PaymentOptionMaster paymentOptionMaster) throws SystemException {
		paymentOptionMaster.setNew(true);

		return paymentOptionMasterPersistence.update(paymentOptionMaster);
	}
	 ...
	 */
	@Override
	public PaymentOptionMaster createPaymentOptionMaster(String PaymentOptionId) {
		return paymentOptionMasterPersistence.create(PaymentOptionId);
	}
	...
	@Override
	public PaymentOptionMaster deletePaymentOptionMaster(String PaymentOptionId)
		throws PortalException, SystemException {
		return paymentOptionMasterPersistence.remove(PaymentOptionId);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public PaymentOptionMaster deletePaymentOptionMaster(
		PaymentOptionMaster paymentOptionMaster) throws SystemException {
		return paymentOptionMasterPersistence.remove(paymentOptionMaster);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(PaymentOptionMaster.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		...
		return paymentOptionMasterPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return paymentOptionMasterPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public PaymentOptionMaster fetchPaymentOptionMaster(String PaymentOptionId)
		throws SystemException {
		return paymentOptionMasterPersistence.fetchByPrimaryKey(PaymentOptionId);
	}
	 ...
	 */
	@Override
	public PaymentOptionMaster getPaymentOptionMaster(String PaymentOptionId)
		throws PortalException, SystemException {
		return paymentOptionMasterPersistence.findByPrimaryKey(PaymentOptionId);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return paymentOptionMasterPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<PaymentOptionMaster> getPaymentOptionMasters(int start, int end)
		throws SystemException {
		return paymentOptionMasterPersistence.findAll(start, end);
	}
	 ...
	 */
	@Override
	public int getPaymentOptionMastersCount() throws SystemException {
		return paymentOptionMasterPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public PaymentOptionMaster updatePaymentOptionMaster(
		PaymentOptionMaster paymentOptionMaster) throws SystemException {
		return paymentOptionMasterPersistence.update(paymentOptionMaster);
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("com.ifli.rapid.model.PaymentOptionMaster",
			paymentOptionMasterLocalService);
	}

	public void destroy() {
		PersistedModelLocalServiceRegistryUtil.unregister(
			"com.ifli.rapid.model.PaymentOptionMaster");
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = paymentOptionMasterPersistence.getDataSource();
	...
	private PaymentOptionMasterLocalServiceClpInvoker _clpInvoker = new PaymentOptionMasterLocalServiceClpInvoker();
}