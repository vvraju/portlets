...
import com.ifli.rapid.service.PolicyPremPercentageLocalService;
...
/**
 * Provides the base implementation for the policy prem percentage local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.ifli.rapid.service.impl.PolicyPremPercentageLocalServiceImpl}.
 * </p>
 *
 * @author Satya Kola
 * @see com.ifli.rapid.service.impl.PolicyPremPercentageLocalServiceImpl
 * @see com.ifli.rapid.service.PolicyPremPercentageLocalServiceUtil
 * @generated
 */
public abstract class PolicyPremPercentageLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements PolicyPremPercentageLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.ifli.rapid.service.PolicyPremPercentageLocalServiceUtil} to access the policy prem percentage local service.
	 */

	/**
	 * Adds the policy prem percentage to the database. Also notifies the appropriate model listeners.
	 *
	 * @param policyPremPercentage the policy prem percentage
	 * @return the policy prem percentage that was added
	 * @throws SystemException if a system exception occurred
	 */
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public PolicyPremPercentage addPolicyPremPercentage(
		PolicyPremPercentage policyPremPercentage) throws SystemException {
		policyPremPercentage.setNew(true);

		return policyPremPercentagePersistence.update(policyPremPercentage);
	}
	 ...
	 */
	@Override
	public PolicyPremPercentage createPolicyPremPercentage(
		int PREM_PERCENTAGE_ID) {
		return policyPremPercentagePersistence.create(PREM_PERCENTAGE_ID);
	}

	/**
	 * Deletes the policy prem percentage with the primary key from the database. Also notifies the appropriate model listeners.
	 *
	 * @param PREM_PERCENTAGE_ID the primary key of the policy prem percentage
	 * @return the policy prem percentage that was removed
	 * @throws PortalException if a policy prem percentage with the primary key could not be found
	 * @throws SystemException if a system exception occurred
	 */
	@Indexable(type = IndexableType.DELETE)
	@Override
	public PolicyPremPercentage deletePolicyPremPercentage(
		int PREM_PERCENTAGE_ID) throws PortalException, SystemException {
		return policyPremPercentagePersistence.remove(PREM_PERCENTAGE_ID);
	}

	/**
	 * Deletes the policy prem percentage from the database. Also notifies the appropriate model listeners.
	 *
	 * @param policyPremPercentage the policy prem percentage
	 * @return the policy prem percentage that was removed
	 * @throws SystemException if a system exception occurred
	...
	public PolicyPremPercentage deletePolicyPremPercentage(
		PolicyPremPercentage policyPremPercentage) throws SystemException {
		return policyPremPercentagePersistence.remove(policyPremPercentage);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(PolicyPremPercentage.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		...
		return policyPremPercentagePersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return policyPremPercentagePersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public PolicyPremPercentage fetchPolicyPremPercentage(
		int PREM_PERCENTAGE_ID) throws SystemException {
		return policyPremPercentagePersistence.fetchByPrimaryKey(PREM_PERCENTAGE_ID);
	}

	/**
	 * Returns the policy prem percentage with the primary key.
	 *
	 * @param PREM_PERCENTAGE_ID the primary key of the policy prem percentage
	 ...
	 */
	@Override
	public PolicyPremPercentage getPolicyPremPercentage(int PREM_PERCENTAGE_ID)
		throws PortalException, SystemException {
		return policyPremPercentagePersistence.findByPrimaryKey(PREM_PERCENTAGE_ID);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return policyPremPercentagePersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<PolicyPremPercentage> getPolicyPremPercentages(int start,
		int end) throws SystemException {
		return policyPremPercentagePersistence.findAll(start, end);
	}
	 ...
	 */
	@Override
	public int getPolicyPremPercentagesCount() throws SystemException {
		return policyPremPercentagePersistence.countAll();
	}

	/**
	 * Updates the policy prem percentage in the database or adds it if it does not yet exist. Also notifies the appropriate model listeners.
	 *
	 * @param policyPremPercentage the policy prem percentage
	 * @return the policy prem percentage that was updated
	 * @throws SystemException if a system exception occurred
	 */
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public PolicyPremPercentage updatePolicyPremPercentage(
		PolicyPremPercentage policyPremPercentage) throws SystemException {
		return policyPremPercentagePersistence.update(policyPremPercentage);
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("com.ifli.rapid.model.PolicyPremPercentage",
			policyPremPercentageLocalService);
	}

	public void destroy() {
		PersistedModelLocalServiceRegistryUtil.unregister(
			"com.ifli.rapid.model.PolicyPremPercentage");
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = policyPremPercentagePersistence.getDataSource();
	...
	private PolicyPremPercentageLocalServiceClpInvoker _clpInvoker = new PolicyPremPercentageLocalServiceClpInvoker();
}