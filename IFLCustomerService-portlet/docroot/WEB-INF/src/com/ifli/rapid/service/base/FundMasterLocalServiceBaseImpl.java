...
import com.ifli.rapid.service.FundMasterLocalService;
...
/**
 * Provides the base implementation for the fund master local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.ifli.rapid.service.impl.FundMasterLocalServiceImpl}.
 * </p>
 *
 * @author Satya Kola
 * @see com.ifli.rapid.service.impl.FundMasterLocalServiceImpl
 * @see com.ifli.rapid.service.FundMasterLocalServiceUtil
 * @generated
 */
public abstract class FundMasterLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements FundMasterLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.ifli.rapid.service.FundMasterLocalServiceUtil} to access the fund master local service.
	 */
	...
	@Override
	public FundMaster addFundMaster(FundMaster fundMaster)
		throws SystemException {
		fundMaster.setNew(true);

		return fundMasterPersistence.update(fundMaster);
	}
	 ...
	 */
	@Override
	public FundMaster createFundMaster(int FUND_ID) {
		return fundMasterPersistence.create(FUND_ID);
	}
	...
	@Override
	public FundMaster deleteFundMaster(int FUND_ID)
		throws PortalException, SystemException {
		return fundMasterPersistence.remove(FUND_ID);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public FundMaster deleteFundMaster(FundMaster fundMaster)
		throws SystemException {
		return fundMasterPersistence.remove(fundMaster);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(FundMaster.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		throws SystemException {
		return fundMasterPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public List dynamicQuery(DynamicQuery dynamicQuery, int start, int end)
		throws SystemException {
		return fundMasterPersistence.findWithDynamicQuery(dynamicQuery, start,
			end);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return fundMasterPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public FundMaster fetchFundMaster(int FUND_ID) throws SystemException {
		return fundMasterPersistence.fetchByPrimaryKey(FUND_ID);
	}
	 ...
	 */
	@Override
	public FundMaster getFundMaster(int FUND_ID)
		throws PortalException, SystemException {
		return fundMasterPersistence.findByPrimaryKey(FUND_ID);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return fundMasterPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<FundMaster> getFundMasters(int start, int end)
		throws SystemException {
		return fundMasterPersistence.findAll(start, end);
	}
	 ...
	 */
	@Override
	public int getFundMastersCount() throws SystemException {
		return fundMasterPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public FundMaster updateFundMaster(FundMaster fundMaster)
		throws SystemException {
		return fundMasterPersistence.update(fundMaster);
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("com.ifli.rapid.model.FundMaster",
			fundMasterLocalService);
	}

	public void destroy() {
		PersistedModelLocalServiceRegistryUtil.unregister(
			"com.ifli.rapid.model.FundMaster");
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = fundMasterPersistence.getDataSource();
	...
	private FundMasterLocalServiceClpInvoker _clpInvoker = new FundMasterLocalServiceClpInvoker();
}