...
import com.ifli.rapid.service.NavHistoryLocalService;
...
/**
 * Provides the base implementation for the nav history local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.ifli.rapid.service.impl.NavHistoryLocalServiceImpl}.
 * </p>
 *
 * @author Satya Kola
 * @see com.ifli.rapid.service.impl.NavHistoryLocalServiceImpl
 * @see com.ifli.rapid.service.NavHistoryLocalServiceUtil
 * @generated
 */
public abstract class NavHistoryLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements NavHistoryLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.ifli.rapid.service.NavHistoryLocalServiceUtil} to access the nav history local service.
	 */
	...
	@Override
	public NavHistory addNavHistory(NavHistory navHistory)
		throws SystemException {
		navHistory.setNew(true);

		return navHistoryPersistence.update(navHistory);
	}
	 ...
	 */
	@Override
	public NavHistory createNavHistory(long NAV_HISTORY_ID) {
		return navHistoryPersistence.create(NAV_HISTORY_ID);
	}
	...
	@Override
	public NavHistory deleteNavHistory(long NAV_HISTORY_ID)
		throws PortalException, SystemException {
		return navHistoryPersistence.remove(NAV_HISTORY_ID);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public NavHistory deleteNavHistory(NavHistory navHistory)
		throws SystemException {
		return navHistoryPersistence.remove(navHistory);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(NavHistory.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		throws SystemException {
		return navHistoryPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public List dynamicQuery(DynamicQuery dynamicQuery, int start, int end)
		throws SystemException {
		return navHistoryPersistence.findWithDynamicQuery(dynamicQuery, start,
			end);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return navHistoryPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public NavHistory fetchNavHistory(long NAV_HISTORY_ID)
		throws SystemException {
		return navHistoryPersistence.fetchByPrimaryKey(NAV_HISTORY_ID);
	}
	 ...
	 */
	@Override
	public NavHistory getNavHistory(long NAV_HISTORY_ID)
		throws PortalException, SystemException {
		return navHistoryPersistence.findByPrimaryKey(NAV_HISTORY_ID);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return navHistoryPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<NavHistory> getNavHistories(int start, int end)
		throws SystemException {
		return navHistoryPersistence.findAll(start, end);
	}
	 ...
	 */
	@Override
	public int getNavHistoriesCount() throws SystemException {
		return navHistoryPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public NavHistory updateNavHistory(NavHistory navHistory)
		throws SystemException {
		return navHistoryPersistence.update(navHistory);
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("com.ifli.rapid.model.NavHistory",
			navHistoryLocalService);
	}

	public void destroy() {
		PersistedModelLocalServiceRegistryUtil.unregister(
			"com.ifli.rapid.model.NavHistory");
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = navHistoryPersistence.getDataSource();
	...
	private NavHistoryLocalServiceClpInvoker _clpInvoker = new NavHistoryLocalServiceClpInvoker();
}