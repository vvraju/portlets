...
import com.ifli.rapid.service.QRCSubTypeMasterLocalService;
...
/**
 * Provides the base implementation for the q r c sub type master local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.ifli.rapid.service.impl.QRCSubTypeMasterLocalServiceImpl}.
 * </p>
 *
 * @author Satya Kola
 * @see com.ifli.rapid.service.impl.QRCSubTypeMasterLocalServiceImpl
 * @see com.ifli.rapid.service.QRCSubTypeMasterLocalServiceUtil
 * @generated
 */
public abstract class QRCSubTypeMasterLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements QRCSubTypeMasterLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.ifli.rapid.service.QRCSubTypeMasterLocalServiceUtil} to access the q r c sub type master local service.
	 */
	...
	@Override
	public QRCSubTypeMaster addQRCSubTypeMaster(
		QRCSubTypeMaster qrcSubTypeMaster) throws SystemException {
		qrcSubTypeMaster.setNew(true);

		return qrcSubTypeMasterPersistence.update(qrcSubTypeMaster);
	}
	 ...
	 */
	@Override
	public QRCSubTypeMaster createQRCSubTypeMaster(int QRC_SUB_TYPE_ID) {
		return qrcSubTypeMasterPersistence.create(QRC_SUB_TYPE_ID);
	}
	...
	@Override
	public QRCSubTypeMaster deleteQRCSubTypeMaster(int QRC_SUB_TYPE_ID)
		throws PortalException, SystemException {
		return qrcSubTypeMasterPersistence.remove(QRC_SUB_TYPE_ID);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public QRCSubTypeMaster deleteQRCSubTypeMaster(
		QRCSubTypeMaster qrcSubTypeMaster) throws SystemException {
		return qrcSubTypeMasterPersistence.remove(qrcSubTypeMaster);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(QRCSubTypeMaster.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		...
		return qrcSubTypeMasterPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return qrcSubTypeMasterPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public QRCSubTypeMaster fetchQRCSubTypeMaster(int QRC_SUB_TYPE_ID)
		throws SystemException {
		return qrcSubTypeMasterPersistence.fetchByPrimaryKey(QRC_SUB_TYPE_ID);
	}
	 ...
	 */
	@Override
	public QRCSubTypeMaster getQRCSubTypeMaster(int QRC_SUB_TYPE_ID)
		throws PortalException, SystemException {
		return qrcSubTypeMasterPersistence.findByPrimaryKey(QRC_SUB_TYPE_ID);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return qrcSubTypeMasterPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<QRCSubTypeMaster> getQRCSubTypeMasters(int start, int end)
		throws SystemException {
		return qrcSubTypeMasterPersistence.findAll(start, end);
	}
	 ...
	 */
	@Override
	public int getQRCSubTypeMastersCount() throws SystemException {
		return qrcSubTypeMasterPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public QRCSubTypeMaster updateQRCSubTypeMaster(
		QRCSubTypeMaster qrcSubTypeMaster) throws SystemException {
		return qrcSubTypeMasterPersistence.update(qrcSubTypeMaster);
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("com.ifli.rapid.model.QRCSubTypeMaster",
			qrcSubTypeMasterLocalService);
	}

	public void destroy() {
		PersistedModelLocalServiceRegistryUtil.unregister(
			"com.ifli.rapid.model.QRCSubTypeMaster");
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = qrcSubTypeMasterPersistence.getDataSource();
	...
	private QRCSubTypeMasterLocalServiceClpInvoker _clpInvoker = new QRCSubTypeMasterLocalServiceClpInvoker();
}