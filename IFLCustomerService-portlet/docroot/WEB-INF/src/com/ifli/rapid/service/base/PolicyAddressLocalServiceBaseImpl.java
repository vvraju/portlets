...
import com.ifli.rapid.service.PolicyAddressLocalService;
...
/**
 * Provides the base implementation for the policy address local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.ifli.rapid.service.impl.PolicyAddressLocalServiceImpl}.
 * </p>
 *
 * @author Satya Kola
 * @see com.ifli.rapid.service.impl.PolicyAddressLocalServiceImpl
 * @see com.ifli.rapid.service.PolicyAddressLocalServiceUtil
 * @generated
 */
public abstract class PolicyAddressLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements PolicyAddressLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.ifli.rapid.service.PolicyAddressLocalServiceUtil} to access the policy address local service.
	 */
	...
	@Override
	public PolicyAddress addPolicyAddress(PolicyAddress policyAddress)
		throws SystemException {
		policyAddress.setNew(true);

		return policyAddressPersistence.update(policyAddress);
	}
	 ...
	 */
	@Override
	public PolicyAddress createPolicyAddress(int ID) {
		return policyAddressPersistence.create(ID);
	}
	...
	@Override
	public PolicyAddress deletePolicyAddress(int ID)
		throws PortalException, SystemException {
		return policyAddressPersistence.remove(ID);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public PolicyAddress deletePolicyAddress(PolicyAddress policyAddress)
		throws SystemException {
		return policyAddressPersistence.remove(policyAddress);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(PolicyAddress.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		throws SystemException {
		return policyAddressPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return policyAddressPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public PolicyAddress fetchPolicyAddress(int ID) throws SystemException {
		return policyAddressPersistence.fetchByPrimaryKey(ID);
	}
	 ...
	 */
	@Override
	public PolicyAddress getPolicyAddress(int ID)
		throws PortalException, SystemException {
		return policyAddressPersistence.findByPrimaryKey(ID);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return policyAddressPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<PolicyAddress> getPolicyAddresses(int start, int end)
		throws SystemException {
		return policyAddressPersistence.findAll(start, end);
	}
	 ...
	 */
	@Override
	public int getPolicyAddressesCount() throws SystemException {
		return policyAddressPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public PolicyAddress updatePolicyAddress(PolicyAddress policyAddress)
		throws SystemException {
		return policyAddressPersistence.update(policyAddress);
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("com.ifli.rapid.model.PolicyAddress",
			policyAddressLocalService);
	}

	public void destroy() {
		PersistedModelLocalServiceRegistryUtil.unregister(
			"com.ifli.rapid.model.PolicyAddress");
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = policyAddressPersistence.getDataSource();
	...
	private PolicyAddressLocalServiceClpInvoker _clpInvoker = new PolicyAddressLocalServiceClpInvoker();
}