...
import com.ifli.rapid.service.ActiveServiceRequestsLocalService;
...
/**
 * Provides the base implementation for the active service requests local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.ifli.rapid.service.impl.ActiveServiceRequestsLocalServiceImpl}.
 * </p>
 *
 * @author Satya Kola
 * @see com.ifli.rapid.service.impl.ActiveServiceRequestsLocalServiceImpl
 * @see com.ifli.rapid.service.ActiveServiceRequestsLocalServiceUtil
 * @generated
 */
public abstract class ActiveServiceRequestsLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements ActiveServiceRequestsLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.ifli.rapid.service.ActiveServiceRequestsLocalServiceUtil} to access the active service requests local service.
	 */
	...
	@Override
	public ActiveServiceRequests addActiveServiceRequests(
		ActiveServiceRequests activeServiceRequests) throws SystemException {
		activeServiceRequests.setNew(true);

		return activeServiceRequestsPersistence.update(activeServiceRequests);
	}
	 ...
	 */
	@Override
	public ActiveServiceRequests createActiveServiceRequests(int QRC_ASR_ID) {
		return activeServiceRequestsPersistence.create(QRC_ASR_ID);
	}
	...
	@Override
	public ActiveServiceRequests deleteActiveServiceRequests(int QRC_ASR_ID)
		throws PortalException, SystemException {
		return activeServiceRequestsPersistence.remove(QRC_ASR_ID);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public ActiveServiceRequests deleteActiveServiceRequests(
		ActiveServiceRequests activeServiceRequests) throws SystemException {
		return activeServiceRequestsPersistence.remove(activeServiceRequests);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(ActiveServiceRequests.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		...
		return activeServiceRequestsPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return activeServiceRequestsPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public ActiveServiceRequests fetchActiveServiceRequests(int QRC_ASR_ID)
		throws SystemException {
		return activeServiceRequestsPersistence.fetchByPrimaryKey(QRC_ASR_ID);
	}
	 ...
	 */
	@Override
	public ActiveServiceRequests getActiveServiceRequests(int QRC_ASR_ID)
		throws PortalException, SystemException {
		return activeServiceRequestsPersistence.findByPrimaryKey(QRC_ASR_ID);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return activeServiceRequestsPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<ActiveServiceRequests> getActiveServiceRequestses(int start,
		int end) throws SystemException {
		return activeServiceRequestsPersistence.findAll(start, end);
	}
	 ...
	 */
	@Override
	public int getActiveServiceRequestsesCount() throws SystemException {
		return activeServiceRequestsPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public ActiveServiceRequests updateActiveServiceRequests(
		ActiveServiceRequests activeServiceRequests) throws SystemException {
		return activeServiceRequestsPersistence.update(activeServiceRequests);
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("com.ifli.rapid.model.ActiveServiceRequests",
			activeServiceRequestsLocalService);
	}

	public void destroy() {
		PersistedModelLocalServiceRegistryUtil.unregister(
			"com.ifli.rapid.model.ActiveServiceRequests");
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = activeServiceRequestsPersistence.getDataSource();
	...
	private ActiveServiceRequestsLocalServiceClpInvoker _clpInvoker = new ActiveServiceRequestsLocalServiceClpInvoker();
}