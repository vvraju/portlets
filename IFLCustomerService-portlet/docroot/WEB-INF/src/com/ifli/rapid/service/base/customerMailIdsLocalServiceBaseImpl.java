...
import com.ifli.rapid.service.customerMailIdsLocalService;
...
/**
 * Provides the base implementation for the customer mail IDs local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.ifli.rapid.service.impl.customerMailIdsLocalServiceImpl}.
 * </p>
 *
 * @author Satya Kola
 * @see com.ifli.rapid.service.impl.customerMailIdsLocalServiceImpl
 * @see com.ifli.rapid.service.customerMailIdsLocalServiceUtil
 * @generated
 */
public abstract class customerMailIdsLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements customerMailIdsLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.ifli.rapid.service.customerMailIdsLocalServiceUtil} to access the customer mail IDs local service.
	 */
	...
	@Override
	public customerMailIds addcustomerMailIds(customerMailIds customerMailIds)
		throws SystemException {
		customerMailIds.setNew(true);

		return customerMailIdsPersistence.update(customerMailIds);
	}
	 ...
	 */
	@Override
	public customerMailIds createcustomerMailIds(int ID) {
		return customerMailIdsPersistence.create(ID);
	}
	...
	@Override
	public customerMailIds deletecustomerMailIds(int ID)
		throws PortalException, SystemException {
		return customerMailIdsPersistence.remove(ID);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public customerMailIds deletecustomerMailIds(
		customerMailIds customerMailIds) throws SystemException {
		return customerMailIdsPersistence.remove(customerMailIds);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(customerMailIds.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		throws SystemException {
		return customerMailIdsPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return customerMailIdsPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public customerMailIds fetchcustomerMailIds(int ID)
		throws SystemException {
		return customerMailIdsPersistence.fetchByPrimaryKey(ID);
	}
	 ...
	 */
	@Override
	public customerMailIds getcustomerMailIds(int ID)
		throws PortalException, SystemException {
		return customerMailIdsPersistence.findByPrimaryKey(ID);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return customerMailIdsPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<customerMailIds> getcustomerMailIdses(int start, int end)
		throws SystemException {
		return customerMailIdsPersistence.findAll(start, end);
	}
	 ...
	 */
	@Override
	public int getcustomerMailIdsesCount() throws SystemException {
		return customerMailIdsPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public customerMailIds updatecustomerMailIds(
		customerMailIds customerMailIds) throws SystemException {
		return customerMailIdsPersistence.update(customerMailIds);
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("com.ifli.rapid.model.customerMailIds",
			customerMailIdsLocalService);
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = customerMailIdsPersistence.getDataSource();
	...
	private customerMailIdsLocalServiceClpInvoker _clpInvoker = new customerMailIdsLocalServiceClpInvoker();
}