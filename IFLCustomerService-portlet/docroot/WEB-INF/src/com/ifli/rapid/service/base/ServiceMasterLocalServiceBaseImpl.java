...
import com.ifli.rapid.service.ServiceMasterLocalService;
...
/**
 * Provides the base implementation for the service master local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.ifli.rapid.service.impl.ServiceMasterLocalServiceImpl}.
 * </p>
 *
 * @author Satya Kola
 * @see com.ifli.rapid.service.impl.ServiceMasterLocalServiceImpl
 * @see com.ifli.rapid.service.ServiceMasterLocalServiceUtil
 * @generated
 */
public abstract class ServiceMasterLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements ServiceMasterLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.ifli.rapid.service.ServiceMasterLocalServiceUtil} to access the service master local service.
	 */
	...
	@Override
	public ServiceMaster addServiceMaster(ServiceMaster serviceMaster)
		throws SystemException {
		serviceMaster.setNew(true);

		return serviceMasterPersistence.update(serviceMaster);
	}
	 ...
	 */
	@Override
	public ServiceMaster createServiceMaster(int SERVICE_MASTER_ID) {
		return serviceMasterPersistence.create(SERVICE_MASTER_ID);
	}
	...
	@Override
	public ServiceMaster deleteServiceMaster(int SERVICE_MASTER_ID)
		throws PortalException, SystemException {
		return serviceMasterPersistence.remove(SERVICE_MASTER_ID);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public ServiceMaster deleteServiceMaster(ServiceMaster serviceMaster)
		throws SystemException {
		return serviceMasterPersistence.remove(serviceMaster);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(ServiceMaster.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		throws SystemException {
		return serviceMasterPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return serviceMasterPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public ServiceMaster fetchServiceMaster(int SERVICE_MASTER_ID)
		throws SystemException {
		return serviceMasterPersistence.fetchByPrimaryKey(SERVICE_MASTER_ID);
	}
	 ...
	 */
	@Override
	public ServiceMaster getServiceMaster(int SERVICE_MASTER_ID)
		throws PortalException, SystemException {
		return serviceMasterPersistence.findByPrimaryKey(SERVICE_MASTER_ID);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return serviceMasterPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<ServiceMaster> getServiceMasters(int start, int end)
		throws SystemException {
		return serviceMasterPersistence.findAll(start, end);
	}
	 ...
	 */
	@Override
	public int getServiceMastersCount() throws SystemException {
		return serviceMasterPersistence.countAll();
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("com.ifli.rapid.model.ServiceMaster",
			serviceMasterLocalService);
	}

	public void destroy() {
		PersistedModelLocalServiceRegistryUtil.unregister(
			"com.ifli.rapid.model.ServiceMaster");
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = serviceMasterPersistence.getDataSource();
	...
	private ServiceMasterLocalServiceClpInvoker _clpInvoker = new ServiceMasterLocalServiceClpInvoker();
}