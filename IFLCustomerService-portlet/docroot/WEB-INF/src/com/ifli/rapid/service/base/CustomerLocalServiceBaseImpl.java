...
import com.ifli.rapid.service.CustomerLocalService;
 ...
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.ifli.rapid.service.impl.CustomerLocalServiceImpl}.
 * </p>
 *
 * @author Satya Kola
 * @see com.ifli.rapid.service.impl.CustomerLocalServiceImpl
 * @see com.ifli.rapid.service.CustomerLocalServiceUtil
 * @generated
 */
public abstract class CustomerLocalServiceBaseImpl extends BaseLocalServiceImpl
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.ifli.rapid.service.CustomerLocalServiceUtil} to access the customer local service.
	 */
	 ...
	 */
	@Override
	public Customer createCustomer(int CUSTOMER_ID) {
		return customerPersistence.create(CUSTOMER_ID);
	}
	...
	public Customer deleteCustomer(int CUSTOMER_ID)
		...
		return customerPersistence.remove(CUSTOMER_ID);
	}
	...
	@Override
	public Customer fetchCustomer(int CUSTOMER_ID) throws SystemException {
		return customerPersistence.fetchByPrimaryKey(CUSTOMER_ID);
	}
	...
	public Customer getCustomer(int CUSTOMER_ID)
		throws PortalException, SystemException {
		return customerPersistence.findByPrimaryKey(CUSTOMER_ID);
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("com.ifli.rapid.model.Customer",
			customerLocalService);
	}

	public void destroy() {
		PersistedModelLocalServiceRegistryUtil.unregister(
			"com.ifli.rapid.model.Customer");
	}
