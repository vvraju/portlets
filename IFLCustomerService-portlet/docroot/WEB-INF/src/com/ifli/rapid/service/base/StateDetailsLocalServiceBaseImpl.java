...
import com.ifli.rapid.service.StateDetailsLocalService;
...
/**
 * Provides the base implementation for the state details local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.ifli.rapid.service.impl.StateDetailsLocalServiceImpl}.
 * </p>
 *
 * @author Satya Kola
 * @see com.ifli.rapid.service.impl.StateDetailsLocalServiceImpl
 * @see com.ifli.rapid.service.StateDetailsLocalServiceUtil
 * @generated
 */
public abstract class StateDetailsLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements StateDetailsLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.ifli.rapid.service.StateDetailsLocalServiceUtil} to access the state details local service.
	 */
	...
	@Override
	public StateDetails addStateDetails(StateDetails stateDetails)
		throws SystemException {
		stateDetails.setNew(true);

		return stateDetailsPersistence.update(stateDetails);
	}
	 ...
	 */
	@Override
	public StateDetails createStateDetails(int STATE_ID) {
		return stateDetailsPersistence.create(STATE_ID);
	}
	...
	@Override
	public StateDetails deleteStateDetails(int STATE_ID)
		throws PortalException, SystemException {
		return stateDetailsPersistence.remove(STATE_ID);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public StateDetails deleteStateDetails(StateDetails stateDetails)
		throws SystemException {
		return stateDetailsPersistence.remove(stateDetails);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(StateDetails.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		throws SystemException {
		return stateDetailsPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return stateDetailsPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public StateDetails fetchStateDetails(int STATE_ID)
		throws SystemException {
		return stateDetailsPersistence.fetchByPrimaryKey(STATE_ID);
	}
	 ...
	 */
	@Override
	public StateDetails getStateDetails(int STATE_ID)
		throws PortalException, SystemException {
		return stateDetailsPersistence.findByPrimaryKey(STATE_ID);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return stateDetailsPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<StateDetails> getStateDetailses(int start, int end)
		throws SystemException {
		return stateDetailsPersistence.findAll(start, end);
	}
	 ...
	 */
	@Override
	public int getStateDetailsesCount() throws SystemException {
		return stateDetailsPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public StateDetails updateStateDetails(StateDetails stateDetails)
		throws SystemException {
		return stateDetailsPersistence.update(stateDetails);
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("com.ifli.rapid.model.StateDetails",
			stateDetailsLocalService);
	}

	public void destroy() {
		PersistedModelLocalServiceRegistryUtil.unregister(
			"com.ifli.rapid.model.StateDetails");
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = stateDetailsPersistence.getDataSource();
	...
	private StateDetailsLocalServiceClpInvoker _clpInvoker = new StateDetailsLocalServiceClpInvoker();
}