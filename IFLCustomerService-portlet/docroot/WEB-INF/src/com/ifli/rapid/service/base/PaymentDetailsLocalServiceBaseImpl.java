...
import com.ifli.rapid.service.PaymentDetailsLocalService;
...
/**
 * Provides the base implementation for the payment details local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.ifli.rapid.service.impl.PaymentDetailsLocalServiceImpl}.
 * </p>
 *
 * @author Satya Kola
 * @see com.ifli.rapid.service.impl.PaymentDetailsLocalServiceImpl
 * @see com.ifli.rapid.service.PaymentDetailsLocalServiceUtil
 * @generated
 */
public abstract class PaymentDetailsLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements PaymentDetailsLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.ifli.rapid.service.PaymentDetailsLocalServiceUtil} to access the payment details local service.
	 */
	...
	public PaymentDetails addPaymentDetails(PaymentDetails paymentDetails)
		...
		return paymentDetailsPersistence.update(paymentDetails);
	}
	 ...
	 */
	@Override
	public PaymentDetails createPaymentDetails(int PaymentId) {
		return paymentDetailsPersistence.create(PaymentId);
	}
	...
	@Override
	public PaymentDetails deletePaymentDetails(int PaymentId)
		throws PortalException, SystemException {
		return paymentDetailsPersistence.remove(PaymentId);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public PaymentDetails deletePaymentDetails(PaymentDetails paymentDetails)
		throws SystemException {
		return paymentDetailsPersistence.remove(paymentDetails);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(PaymentDetails.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		throws SystemException {
		return paymentDetailsPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return paymentDetailsPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public PaymentDetails fetchPaymentDetails(int PaymentId)
		throws SystemException {
		return paymentDetailsPersistence.fetchByPrimaryKey(PaymentId);
	}
	...
	public PaymentDetails getPaymentDetails(int PaymentId)
		throws PortalException, SystemException {
		return paymentDetailsPersistence.findByPrimaryKey(PaymentId);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return paymentDetailsPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<PaymentDetails> getPaymentDetailses(int start, int end)
		throws SystemException {
		return paymentDetailsPersistence.findAll(start, end);
	}
	 ...
	 */
	@Override
	public int getPaymentDetailsesCount() throws SystemException {
		return paymentDetailsPersistence.countAll();
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("com.ifli.rapid.model.PaymentDetails",
			paymentDetailsLocalService);
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = paymentDetailsPersistence.getDataSource();
	...
	private PaymentDetailsLocalServiceClpInvoker _clpInvoker = new PaymentDetailsLocalServiceClpInvoker();
}