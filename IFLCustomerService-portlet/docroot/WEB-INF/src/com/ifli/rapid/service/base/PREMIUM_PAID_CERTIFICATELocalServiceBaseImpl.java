...
import com.ifli.rapid.service.PREMIUM_PAID_CERTIFICATELocalService;
...
/**
 * Provides the base implementation for the p r e m i u m_ p a i d_ c e r t i f i c a t e local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.ifli.rapid.service.impl.PREMIUM_PAID_CERTIFICATELocalServiceImpl}.
 * </p>
 *
 * @author Satya Kola
 * @see com.ifli.rapid.service.impl.PREMIUM_PAID_CERTIFICATELocalServiceImpl
 * @see com.ifli.rapid.service.PREMIUM_PAID_CERTIFICATELocalServiceUtil
 * @generated
 */
public abstract class PREMIUM_PAID_CERTIFICATELocalServiceBaseImpl
	extends BaseLocalServiceImpl implements PREMIUM_PAID_CERTIFICATELocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.ifli.rapid.service.PREMIUM_PAID_CERTIFICATELocalServiceUtil} to access the p r e m i u m_ p a i d_ c e r t i f i c a t e local service.
	 */
	...
	@Override
	public PREMIUM_PAID_CERTIFICATE addPREMIUM_PAID_CERTIFICATE(
		PREMIUM_PAID_CERTIFICATE premium_paid_certificate)
		throws SystemException {
		premium_paid_certificate.setNew(true);

		return premium_paid_certificatePersistence.update(premium_paid_certificate);
	}
	 ...
	 */
	@Override
	public PREMIUM_PAID_CERTIFICATE createPREMIUM_PAID_CERTIFICATE(long ID) {
		return premium_paid_certificatePersistence.create(ID);
	}
	...
	@Override
	public PREMIUM_PAID_CERTIFICATE deletePREMIUM_PAID_CERTIFICATE(long ID)
		throws PortalException, SystemException {
		return premium_paid_certificatePersistence.remove(ID);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public PREMIUM_PAID_CERTIFICATE deletePREMIUM_PAID_CERTIFICATE(
		PREMIUM_PAID_CERTIFICATE premium_paid_certificate)
		throws SystemException {
		return premium_paid_certificatePersistence.remove(premium_paid_certificate);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(PREMIUM_PAID_CERTIFICATE.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		throws SystemException {
		return premium_paid_certificatePersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return premium_paid_certificatePersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public PREMIUM_PAID_CERTIFICATE fetchPREMIUM_PAID_CERTIFICATE(long ID)
		throws SystemException {
		return premium_paid_certificatePersistence.fetchByPrimaryKey(ID);
	}
	 ...
	 */
	@Override
	public PREMIUM_PAID_CERTIFICATE getPREMIUM_PAID_CERTIFICATE(long ID)
		throws PortalException, SystemException {
		return premium_paid_certificatePersistence.findByPrimaryKey(ID);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return premium_paid_certificatePersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<PREMIUM_PAID_CERTIFICATE> getPREMIUM_PAID_CERTIFICATEs(
		int start, int end) throws SystemException {
		return premium_paid_certificatePersistence.findAll(start, end);
	}
	 ...
	 */
	@Override
	public int getPREMIUM_PAID_CERTIFICATEsCount() throws SystemException {
		return premium_paid_certificatePersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public PREMIUM_PAID_CERTIFICATE updatePREMIUM_PAID_CERTIFICATE(
		PREMIUM_PAID_CERTIFICATE premium_paid_certificate)
		throws SystemException {
		return premium_paid_certificatePersistence.update(premium_paid_certificate);
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("com.ifli.rapid.model.PREMIUM_PAID_CERTIFICATE",
			premium_paid_certificateLocalService);
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = premium_paid_certificatePersistence.getDataSource();
	...
	private PREMIUM_PAID_CERTIFICATELocalServiceClpInvoker _clpInvoker = new PREMIUM_PAID_CERTIFICATELocalServiceClpInvoker();
}