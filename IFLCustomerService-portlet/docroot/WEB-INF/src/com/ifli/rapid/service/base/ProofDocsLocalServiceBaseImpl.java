...
import com.ifli.rapid.service.ProofDocsLocalService;
...
/**
 * Provides the base implementation for the proof docs local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.ifli.rapid.service.impl.ProofDocsLocalServiceImpl}.
 * </p>
 *
 * @author Satya Kola
 * @see com.ifli.rapid.service.impl.ProofDocsLocalServiceImpl
 * @see com.ifli.rapid.service.ProofDocsLocalServiceUtil
 * @generated
 */
public abstract class ProofDocsLocalServiceBaseImpl extends BaseLocalServiceImpl
	implements ProofDocsLocalService, IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.ifli.rapid.service.ProofDocsLocalServiceUtil} to access the proof docs local service.
	 */
	...
	@Override
	public ProofDocs addProofDocs(ProofDocs proofDocs)
		throws SystemException {
		proofDocs.setNew(true);

		return proofDocsPersistence.update(proofDocs);
	}
	 ...
	 */
	@Override
	public ProofDocs createProofDocs(long ID) {
		return proofDocsPersistence.create(ID);
	}
	...
	@Override
	public ProofDocs deleteProofDocs(long ID)
		throws PortalException, SystemException {
		return proofDocsPersistence.remove(ID);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public ProofDocs deleteProofDocs(ProofDocs proofDocs)
		throws SystemException {
		return proofDocsPersistence.remove(proofDocs);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(ProofDocs.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		throws SystemException {
		return proofDocsPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public List dynamicQuery(DynamicQuery dynamicQuery, int start, int end)
		throws SystemException {
		return proofDocsPersistence.findWithDynamicQuery(dynamicQuery, start,
			end);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return proofDocsPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public ProofDocs fetchProofDocs(long ID) throws SystemException {
		return proofDocsPersistence.fetchByPrimaryKey(ID);
	}
	 ...
	 */
	@Override
	public ProofDocs getProofDocs(long ID)
		throws PortalException, SystemException {
		return proofDocsPersistence.findByPrimaryKey(ID);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return proofDocsPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<ProofDocs> getProofDocses(int start, int end)
		throws SystemException {
		return proofDocsPersistence.findAll(start, end);
	}
	 ...
	 */
	@Override
	public int getProofDocsesCount() throws SystemException {
		return proofDocsPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public ProofDocs updateProofDocs(ProofDocs proofDocs)
		throws SystemException {
		return proofDocsPersistence.update(proofDocs);
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("com.ifli.rapid.model.ProofDocs",
			proofDocsLocalService);
	}

	public void destroy() {
		PersistedModelLocalServiceRegistryUtil.unregister(
			"com.ifli.rapid.model.ProofDocs");
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = proofDocsPersistence.getDataSource();
	...
	private ProofDocsLocalServiceClpInvoker _clpInvoker = new ProofDocsLocalServiceClpInvoker();
}