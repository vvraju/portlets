...
import com.ifli.rapid.service.PolicyFundLocalService;
...
/**
 * Provides the base implementation for the policy fund local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.ifli.rapid.service.impl.PolicyFundLocalServiceImpl}.
 * </p>
 *
 * @author Satya Kola
 * @see com.ifli.rapid.service.impl.PolicyFundLocalServiceImpl
 * @see com.ifli.rapid.service.PolicyFundLocalServiceUtil
 * @generated
 */
public abstract class PolicyFundLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements PolicyFundLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.ifli.rapid.service.PolicyFundLocalServiceUtil} to access the policy fund local service.
	 */
	...
	@Override
	public PolicyFund addPolicyFund(PolicyFund policyFund)
		throws SystemException {
		policyFund.setNew(true);

		return policyFundPersistence.update(policyFund);
	}
	 ...
	 */
	@Override
	public PolicyFund createPolicyFund(int POLICY_FUND_ID) {
		return policyFundPersistence.create(POLICY_FUND_ID);
	}
	...
	@Override
	public PolicyFund deletePolicyFund(int POLICY_FUND_ID)
		throws PortalException, SystemException {
		return policyFundPersistence.remove(POLICY_FUND_ID);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public PolicyFund deletePolicyFund(PolicyFund policyFund)
		throws SystemException {
		return policyFundPersistence.remove(policyFund);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(PolicyFund.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		throws SystemException {
		return policyFundPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public List dynamicQuery(DynamicQuery dynamicQuery, int start, int end)
		throws SystemException {
		return policyFundPersistence.findWithDynamicQuery(dynamicQuery, start,
			end);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return policyFundPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public PolicyFund fetchPolicyFund(int POLICY_FUND_ID)
		throws SystemException {
		return policyFundPersistence.fetchByPrimaryKey(POLICY_FUND_ID);
	}
	 ...
	 */
	@Override
	public PolicyFund getPolicyFund(int POLICY_FUND_ID)
		throws PortalException, SystemException {
		return policyFundPersistence.findByPrimaryKey(POLICY_FUND_ID);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return policyFundPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<PolicyFund> getPolicyFunds(int start, int end)
		throws SystemException {
		return policyFundPersistence.findAll(start, end);
	}
	 ...
	 */
	@Override
	public int getPolicyFundsCount() throws SystemException {
		return policyFundPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public PolicyFund updatePolicyFund(PolicyFund policyFund)
		throws SystemException {
		return policyFundPersistence.update(policyFund);
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("com.ifli.rapid.model.PolicyFund",
			policyFundLocalService);
	}

	public void destroy() {
		PersistedModelLocalServiceRegistryUtil.unregister(
			"com.ifli.rapid.model.PolicyFund");
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = policyFundPersistence.getDataSource();
	...
	private PolicyFundLocalServiceClpInvoker _clpInvoker = new PolicyFundLocalServiceClpInvoker();
}