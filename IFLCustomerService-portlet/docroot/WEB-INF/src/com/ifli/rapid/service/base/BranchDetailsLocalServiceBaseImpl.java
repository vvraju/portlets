...
import com.ifli.rapid.service.BranchDetailsLocalService;
...
/**
 * Provides the base implementation for the branch details local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.ifli.rapid.service.impl.BranchDetailsLocalServiceImpl}.
 * </p>
 *
 * @author Satya Kola
 * @see com.ifli.rapid.service.impl.BranchDetailsLocalServiceImpl
 * @see com.ifli.rapid.service.BranchDetailsLocalServiceUtil
 * @generated
 */
public abstract class BranchDetailsLocalServiceBaseImpl
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.ifli.rapid.service.BranchDetailsLocalServiceUtil} to access the branch details local service.
	 */

	/**
	 * Adds the branch details to the database. Also notifies the appropriate model listeners.
	 *
	 * @param branchDetails the branch details
	 * @return the branch details that was added
	 ...
	 */
	@Override
	public BranchDetails createBranchDetails(int BRANCH_ID) {
		return branchDetailsPersistence.create(BRANCH_ID);
	}

	/**
	 * Deletes the branch details with the primary key from the database. Also notifies the appropriate model listeners.
	 *
	 * @param BRANCH_ID the primary key of the branch details
	 * @return the branch details that was removed
	 * @throws PortalException if a branch details with the primary key could not be found
	 * @throws SystemException if a system exception occurred
	 */
	@Indexable(type = IndexableType.DELETE)
	@Override
	public BranchDetails deleteBranchDetails(int BRANCH_ID)
		throws PortalException, SystemException {
		return branchDetailsPersistence.remove(BRANCH_ID);
	}

	/**
	 * Deletes the branch details from the database. Also notifies the appropriate model listeners.
	 *
	 * @param branchDetails the branch details
	 * @return the branch details that was removed
	 * @throws SystemException if a system exception occurred
	...
	@Override
	public BranchDetails fetchBranchDetails(int BRANCH_ID)
		throws SystemException {
		return branchDetailsPersistence.fetchByPrimaryKey(BRANCH_ID);
	}

	/**
	 * Returns the branch details with the primary key.
	 *
	 * @param BRANCH_ID the primary key of the branch details
	 ...
	 */
	@Override
	public BranchDetails getBranchDetails(int BRANCH_ID)
		throws PortalException, SystemException {
	 ...
	 */
	@Override
	public int getBranchDetailsesCount() throws SystemException {
		return branchDetailsPersistence.countAll();
	}

	/**
	 * Updates the branch details in the database or adds it if it does not yet exist. Also notifies the appropriate model listeners.
	 *
	 * @param branchDetails the branch details
	 * @return the branch details that was updated
	 * @throws SystemException if a system exception occurred
	 */
	@Indexable(type = IndexableType.REINDEX)
	@Override
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("com.ifli.rapid.model.BranchDetails",
			branchDetailsLocalService);
	}

	public void destroy() {
		PersistedModelLocalServiceRegistryUtil.unregister(
			"com.ifli.rapid.model.BranchDetails");
	}
