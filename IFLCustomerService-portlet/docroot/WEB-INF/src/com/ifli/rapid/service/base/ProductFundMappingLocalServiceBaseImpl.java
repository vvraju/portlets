...
import com.ifli.rapid.service.ProductFundMappingLocalService;
...
/**
 * Provides the base implementation for the product fund mapping local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.ifli.rapid.service.impl.ProductFundMappingLocalServiceImpl}.
 * </p>
 *
 * @author Satya Kola
 * @see com.ifli.rapid.service.impl.ProductFundMappingLocalServiceImpl
 * @see com.ifli.rapid.service.ProductFundMappingLocalServiceUtil
 * @generated
 */
public abstract class ProductFundMappingLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements ProductFundMappingLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.ifli.rapid.service.ProductFundMappingLocalServiceUtil} to access the product fund mapping local service.
	 */
	...
	@Override
	public ProductFundMapping addProductFundMapping(
		ProductFundMapping productFundMapping) throws SystemException {
		productFundMapping.setNew(true);

		return productFundMappingPersistence.update(productFundMapping);
	}
	 ...
	 */
	@Override
	public ProductFundMapping createProductFundMapping(int ID) {
		return productFundMappingPersistence.create(ID);
	}
	...
	@Override
	public ProductFundMapping deleteProductFundMapping(int ID)
		throws PortalException, SystemException {
		return productFundMappingPersistence.remove(ID);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public ProductFundMapping deleteProductFundMapping(
		ProductFundMapping productFundMapping) throws SystemException {
		return productFundMappingPersistence.remove(productFundMapping);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(ProductFundMapping.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		...
		return productFundMappingPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return productFundMappingPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public ProductFundMapping fetchProductFundMapping(int ID)
		throws SystemException {
		return productFundMappingPersistence.fetchByPrimaryKey(ID);
	}
	 ...
	 */
	@Override
	public ProductFundMapping getProductFundMapping(int ID)
		throws PortalException, SystemException {
		return productFundMappingPersistence.findByPrimaryKey(ID);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return productFundMappingPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<ProductFundMapping> getProductFundMappings(int start, int end)
		throws SystemException {
		return productFundMappingPersistence.findAll(start, end);
	}
	 ...
	 */
	@Override
	public int getProductFundMappingsCount() throws SystemException {
		return productFundMappingPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public ProductFundMapping updateProductFundMapping(
		ProductFundMapping productFundMapping) throws SystemException {
		return productFundMappingPersistence.update(productFundMapping);
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("com.ifli.rapid.model.ProductFundMapping",
			productFundMappingLocalService);
	}

	public void destroy() {
		PersistedModelLocalServiceRegistryUtil.unregister(
			"com.ifli.rapid.model.ProductFundMapping");
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = productFundMappingPersistence.getDataSource();
	...
	private ProductFundMappingLocalServiceClpInvoker _clpInvoker = new ProductFundMappingLocalServiceClpInvoker();
}