...
import com.ifli.rapid.service.CustomerTempLocalService;
...
/**
 * Provides the base implementation for the customer temp local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.ifli.rapid.service.impl.CustomerTempLocalServiceImpl}.
 * </p>
 *
 * @author Satya Kola
 ...
 * @generated
 */
public abstract class CustomerTempLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements CustomerTempLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.ifli.rapid.service.CustomerTempLocalServiceUtil} to access the customer temp local service.
	 */
	...
	@Override
	public CustomerTemp addCustomerTemp(CustomerTemp customerTemp)
		throws SystemException {
		customerTemp.setNew(true);

		return customerTempPersistence.update(customerTemp);
	}
	 ...
	 */
	@Override
	public CustomerTemp createCustomerTemp(String CUSTOMER_ID) {
		return customerTempPersistence.create(CUSTOMER_ID);
	}
	...
	@Override
	public CustomerTemp deleteCustomerTemp(String CUSTOMER_ID)
		throws PortalException, SystemException {
		return customerTempPersistence.remove(CUSTOMER_ID);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public CustomerTemp deleteCustomerTemp(CustomerTemp customerTemp)
		throws SystemException {
		return customerTempPersistence.remove(customerTemp);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(CustomerTemp.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		throws SystemException {
		return customerTempPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return customerTempPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public CustomerTemp fetchCustomerTemp(String CUSTOMER_ID)
		throws SystemException {
		return customerTempPersistence.fetchByPrimaryKey(CUSTOMER_ID);
	}
	 ...
	 */
	@Override
	public CustomerTemp getCustomerTemp(String CUSTOMER_ID)
		throws PortalException, SystemException {
		return customerTempPersistence.findByPrimaryKey(CUSTOMER_ID);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return customerTempPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<CustomerTemp> getCustomerTemps(int start, int end)
		throws SystemException {
		return customerTempPersistence.findAll(start, end);
	}
	 ...
	 */
	@Override
	public int getCustomerTempsCount() throws SystemException {
		return customerTempPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public CustomerTemp updateCustomerTemp(CustomerTemp customerTemp)
		throws SystemException {
		return customerTempPersistence.update(customerTemp);
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("com.ifli.rapid.model.CustomerTemp",
			customerTempLocalService);
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = customerTempPersistence.getDataSource();
	...
	private CustomerTempLocalServiceClpInvoker _clpInvoker = new CustomerTempLocalServiceClpInvoker();
}