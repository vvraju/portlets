...
import com.ifli.rapid.service.FamilyRelationsLocalService;
...
/**
 * Provides the base implementation for the family relations local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.ifli.rapid.service.impl.FamilyRelationsLocalServiceImpl}.
 * </p>
 *
 * @author Satya Kola
 * @see com.ifli.rapid.service.impl.FamilyRelationsLocalServiceImpl
 * @see com.ifli.rapid.service.FamilyRelationsLocalServiceUtil
 * @generated
 */
public abstract class FamilyRelationsLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements FamilyRelationsLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.ifli.rapid.service.FamilyRelationsLocalServiceUtil} to access the family relations local service.
	 */
	...
	@Override
	public FamilyRelations addFamilyRelations(FamilyRelations familyRelations)
		throws SystemException {
		familyRelations.setNew(true);

		return familyRelationsPersistence.update(familyRelations);
	}
	 ...
	 */
	@Override
	public FamilyRelations createFamilyRelations(int RELATION_ID) {
		return familyRelationsPersistence.create(RELATION_ID);
	}
	...
	@Override
	public FamilyRelations deleteFamilyRelations(int RELATION_ID)
		throws PortalException, SystemException {
		return familyRelationsPersistence.remove(RELATION_ID);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public FamilyRelations deleteFamilyRelations(
		FamilyRelations familyRelations) throws SystemException {
		return familyRelationsPersistence.remove(familyRelations);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(FamilyRelations.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		throws SystemException {
		return familyRelationsPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return familyRelationsPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public FamilyRelations fetchFamilyRelations(int RELATION_ID)
		throws SystemException {
		return familyRelationsPersistence.fetchByPrimaryKey(RELATION_ID);
	}
	 ...
	 */
	@Override
	public FamilyRelations getFamilyRelations(int RELATION_ID)
		throws PortalException, SystemException {
		return familyRelationsPersistence.findByPrimaryKey(RELATION_ID);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return familyRelationsPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<FamilyRelations> getFamilyRelationses(int start, int end)
		throws SystemException {
		return familyRelationsPersistence.findAll(start, end);
	}
	 ...
	 */
	@Override
	public int getFamilyRelationsesCount() throws SystemException {
		return familyRelationsPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public FamilyRelations updateFamilyRelations(
		FamilyRelations familyRelations) throws SystemException {
		return familyRelationsPersistence.update(familyRelations);
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("com.ifli.rapid.model.FamilyRelations",
			familyRelationsLocalService);
	}

	public void destroy() {
		PersistedModelLocalServiceRegistryUtil.unregister(
			"com.ifli.rapid.model.FamilyRelations");
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = familyRelationsPersistence.getDataSource();
	...
	private FamilyRelationsLocalServiceClpInvoker _clpInvoker = new FamilyRelationsLocalServiceClpInvoker();
}