...
import com.ifli.rapid.service.ServiceSubMasterLocalService;
...
/**
 * Provides the base implementation for the service sub master local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.ifli.rapid.service.impl.ServiceSubMasterLocalServiceImpl}.
 * </p>
 *
 * @author Satya Kola
 * @see com.ifli.rapid.service.impl.ServiceSubMasterLocalServiceImpl
 * @see com.ifli.rapid.service.ServiceSubMasterLocalServiceUtil
 * @generated
 */
public abstract class ServiceSubMasterLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements ServiceSubMasterLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.ifli.rapid.service.ServiceSubMasterLocalServiceUtil} to access the service sub master local service.
	 */
	...
	@Override
	public ServiceSubMaster addServiceSubMaster(
		ServiceSubMaster serviceSubMaster) throws SystemException {
		serviceSubMaster.setNew(true);

		return serviceSubMasterPersistence.update(serviceSubMaster);
	}
	 ...
	 */
	@Override
	public ServiceSubMaster createServiceSubMaster(int SUBMASTER_ID) {
		return serviceSubMasterPersistence.create(SUBMASTER_ID);
	}
	...
	@Override
	public ServiceSubMaster deleteServiceSubMaster(int SUBMASTER_ID)
		throws PortalException, SystemException {
		return serviceSubMasterPersistence.remove(SUBMASTER_ID);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public ServiceSubMaster deleteServiceSubMaster(
		ServiceSubMaster serviceSubMaster) throws SystemException {
		return serviceSubMasterPersistence.remove(serviceSubMaster);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(ServiceSubMaster.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		...
		return serviceSubMasterPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return serviceSubMasterPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public ServiceSubMaster fetchServiceSubMaster(int SUBMASTER_ID)
		throws SystemException {
		return serviceSubMasterPersistence.fetchByPrimaryKey(SUBMASTER_ID);
	}
	 ...
	 */
	@Override
	public ServiceSubMaster getServiceSubMaster(int SUBMASTER_ID)
		throws PortalException, SystemException {
		return serviceSubMasterPersistence.findByPrimaryKey(SUBMASTER_ID);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return serviceSubMasterPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<ServiceSubMaster> getServiceSubMasters(int start, int end)
		throws SystemException {
		return serviceSubMasterPersistence.findAll(start, end);
	}
	 ...
	 */
	@Override
	public int getServiceSubMastersCount() throws SystemException {
		return serviceSubMasterPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public ServiceSubMaster updateServiceSubMaster(
		ServiceSubMaster serviceSubMaster) throws SystemException {
		return serviceSubMasterPersistence.update(serviceSubMaster);
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("com.ifli.rapid.model.ServiceSubMaster",
			serviceSubMasterLocalService);
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = serviceSubMasterPersistence.getDataSource();
	...
	private ServiceSubMasterLocalServiceClpInvoker _clpInvoker = new ServiceSubMasterLocalServiceClpInvoker();
}