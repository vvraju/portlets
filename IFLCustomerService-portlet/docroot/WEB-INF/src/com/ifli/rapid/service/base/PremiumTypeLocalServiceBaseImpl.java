...
import com.ifli.rapid.service.PremiumTypeLocalService;
...
/**
 * Provides the base implementation for the premium type local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.ifli.rapid.service.impl.PremiumTypeLocalServiceImpl}.
 * </p>
 *
 * @author Satya Kola
 * @see com.ifli.rapid.service.impl.PremiumTypeLocalServiceImpl
 * @see com.ifli.rapid.service.PremiumTypeLocalServiceUtil
 * @generated
 */
public abstract class PremiumTypeLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements PremiumTypeLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.ifli.rapid.service.PremiumTypeLocalServiceUtil} to access the premium type local service.
	 */
	...
	@Override
	public PremiumType addPremiumType(PremiumType premiumType)
		throws SystemException {
		premiumType.setNew(true);

		return premiumTypePersistence.update(premiumType);
	}
	 ...
	 */
	@Override
	public PremiumType createPremiumType(String Id) {
		return premiumTypePersistence.create(Id);
	}
	...
	@Override
	public PremiumType deletePremiumType(String Id)
		throws PortalException, SystemException {
		return premiumTypePersistence.remove(Id);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public PremiumType deletePremiumType(PremiumType premiumType)
		throws SystemException {
		return premiumTypePersistence.remove(premiumType);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(PremiumType.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		throws SystemException {
		return premiumTypePersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public List dynamicQuery(DynamicQuery dynamicQuery, int start, int end)
		throws SystemException {
		return premiumTypePersistence.findWithDynamicQuery(dynamicQuery, start,
			end);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return premiumTypePersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public PremiumType fetchPremiumType(String Id) throws SystemException {
		return premiumTypePersistence.fetchByPrimaryKey(Id);
	}
	 ...
	 */
	@Override
	public PremiumType getPremiumType(String Id)
		throws PortalException, SystemException {
		return premiumTypePersistence.findByPrimaryKey(Id);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return premiumTypePersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<PremiumType> getPremiumTypes(int start, int end)
		throws SystemException {
		return premiumTypePersistence.findAll(start, end);
	}
	 ...
	 */
	@Override
	public int getPremiumTypesCount() throws SystemException {
		return premiumTypePersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public PremiumType updatePremiumType(PremiumType premiumType)
		throws SystemException {
		return premiumTypePersistence.update(premiumType);
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("com.ifli.rapid.model.PremiumType",
			premiumTypeLocalService);
	}

	public void destroy() {
		PersistedModelLocalServiceRegistryUtil.unregister(
			"com.ifli.rapid.model.PremiumType");
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = premiumTypePersistence.getDataSource();
	...
	private PremiumTypeLocalServiceClpInvoker _clpInvoker = new PremiumTypeLocalServiceClpInvoker();
}