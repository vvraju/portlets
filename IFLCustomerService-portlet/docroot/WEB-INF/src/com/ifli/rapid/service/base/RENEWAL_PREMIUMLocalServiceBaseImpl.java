...
import com.ifli.rapid.service.RENEWAL_PREMIUMLocalService;
...
/**
 * Provides the base implementation for the r e n e w a l_ p r e m i u m local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.ifli.rapid.service.impl.RENEWAL_PREMIUMLocalServiceImpl}.
 * </p>
 *
 * @author Satya Kola
 ...
 * @generated
 */
public abstract class RENEWAL_PREMIUMLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements RENEWAL_PREMIUMLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.ifli.rapid.service.RENEWAL_PREMIUMLocalServiceUtil} to access the r e n e w a l_ p r e m i u m local service.
	 */
	...
	@Override
	public RENEWAL_PREMIUM addRENEWAL_PREMIUM(RENEWAL_PREMIUM renewal_premium)
		throws SystemException {
		renewal_premium.setNew(true);

		return renewal_premiumPersistence.update(renewal_premium);
	}
	 ...
	 */
	@Override
	public RENEWAL_PREMIUM createRENEWAL_PREMIUM(long ID_old) {
		return renewal_premiumPersistence.create(ID_old);
	}
	...
	@Override
	public RENEWAL_PREMIUM deleteRENEWAL_PREMIUM(long ID_old)
		throws PortalException, SystemException {
		return renewal_premiumPersistence.remove(ID_old);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public RENEWAL_PREMIUM deleteRENEWAL_PREMIUM(
		RENEWAL_PREMIUM renewal_premium) throws SystemException {
		return renewal_premiumPersistence.remove(renewal_premium);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(RENEWAL_PREMIUM.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		throws SystemException {
		return renewal_premiumPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return renewal_premiumPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public RENEWAL_PREMIUM fetchRENEWAL_PREMIUM(long ID_old)
		throws SystemException {
		return renewal_premiumPersistence.fetchByPrimaryKey(ID_old);
	}
	 ...
	 */
	@Override
	public RENEWAL_PREMIUM getRENEWAL_PREMIUM(long ID_old)
		throws PortalException, SystemException {
		return renewal_premiumPersistence.findByPrimaryKey(ID_old);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return renewal_premiumPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<RENEWAL_PREMIUM> getRENEWAL_PREMIUMs(int start, int end)
		throws SystemException {
		return renewal_premiumPersistence.findAll(start, end);
	}
	 ...
	 */
	@Override
	public int getRENEWAL_PREMIUMsCount() throws SystemException {
		return renewal_premiumPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public RENEWAL_PREMIUM updateRENEWAL_PREMIUM(
		RENEWAL_PREMIUM renewal_premium) throws SystemException {
		return renewal_premiumPersistence.update(renewal_premium);
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("com.ifli.rapid.model.RENEWAL_PREMIUM",
			renewal_premiumLocalService);
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = renewal_premiumPersistence.getDataSource();
	...
	private RENEWAL_PREMIUMLocalServiceClpInvoker _clpInvoker = new RENEWAL_PREMIUMLocalServiceClpInvoker();
}