...
import com.ifli.rapid.service.TempCustomerLocalService;
...
/**
 * Provides the base implementation for the temp customer local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.ifli.rapid.service.impl.TempCustomerLocalServiceImpl}.
 * </p>
 *
 * @author Satya Kola
 * @see com.ifli.rapid.service.impl.TempCustomerLocalServiceImpl
 * @see com.ifli.rapid.service.TempCustomerLocalServiceUtil
 * @generated
 */
public abstract class TempCustomerLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements TempCustomerLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.ifli.rapid.service.TempCustomerLocalServiceUtil} to access the temp customer local service.
	 */
	...
	@Override
	public TempCustomer addTempCustomer(TempCustomer tempCustomer)
		throws SystemException {
		tempCustomer.setNew(true);

		return tempCustomerPersistence.update(tempCustomer);
	}
	 ...
	 */
	@Override
	public TempCustomer createTempCustomer(int CUSTOMER_ID) {
		return tempCustomerPersistence.create(CUSTOMER_ID);
	}
	...
	@Override
	public TempCustomer deleteTempCustomer(int CUSTOMER_ID)
		throws PortalException, SystemException {
		return tempCustomerPersistence.remove(CUSTOMER_ID);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public TempCustomer deleteTempCustomer(TempCustomer tempCustomer)
		throws SystemException {
		return tempCustomerPersistence.remove(tempCustomer);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(TempCustomer.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		throws SystemException {
		return tempCustomerPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return tempCustomerPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public TempCustomer fetchTempCustomer(int CUSTOMER_ID)
		throws SystemException {
		return tempCustomerPersistence.fetchByPrimaryKey(CUSTOMER_ID);
	}
	 ...
	 */
	@Override
	public TempCustomer getTempCustomer(int CUSTOMER_ID)
		throws PortalException, SystemException {
		return tempCustomerPersistence.findByPrimaryKey(CUSTOMER_ID);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return tempCustomerPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<TempCustomer> getTempCustomers(int start, int end)
		throws SystemException {
		return tempCustomerPersistence.findAll(start, end);
	}
	 ...
	 */
	@Override
	public int getTempCustomersCount() throws SystemException {
		return tempCustomerPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public TempCustomer updateTempCustomer(TempCustomer tempCustomer)
		throws SystemException {
		return tempCustomerPersistence.update(tempCustomer);
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("com.ifli.rapid.model.TempCustomer",
			tempCustomerLocalService);
	}

	public void destroy() {
		PersistedModelLocalServiceRegistryUtil.unregister(
			"com.ifli.rapid.model.TempCustomer");
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = tempCustomerPersistence.getDataSource();
	...
	private TempCustomerLocalServiceClpInvoker _clpInvoker = new TempCustomerLocalServiceClpInvoker();
}