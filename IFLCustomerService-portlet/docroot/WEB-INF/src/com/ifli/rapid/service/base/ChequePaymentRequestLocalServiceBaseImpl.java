...
import com.ifli.rapid.service.ChequePaymentRequestLocalService;
...
/**
 * Provides the base implementation for the cheque payment request local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.ifli.rapid.service.impl.ChequePaymentRequestLocalServiceImpl}.
 * </p>
 *
 * @author Satya Kola
 * @see com.ifli.rapid.service.impl.ChequePaymentRequestLocalServiceImpl
 * @see com.ifli.rapid.service.ChequePaymentRequestLocalServiceUtil
 * @generated
 */
public abstract class ChequePaymentRequestLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements ChequePaymentRequestLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.ifli.rapid.service.ChequePaymentRequestLocalServiceUtil} to access the cheque payment request local service.
	 */
	...
	@Override
	public ChequePaymentRequest addChequePaymentRequest(
		ChequePaymentRequest chequePaymentRequest) throws SystemException {
		chequePaymentRequest.setNew(true);

		return chequePaymentRequestPersistence.update(chequePaymentRequest);
	}
	 ...
	 */
	@Override
	public ChequePaymentRequest createChequePaymentRequest(
		String ServiceRequestID) {
		return chequePaymentRequestPersistence.create(ServiceRequestID);
	}
	...
	@Override
	public ChequePaymentRequest deleteChequePaymentRequest(
		String ServiceRequestID) throws PortalException, SystemException {
		return chequePaymentRequestPersistence.remove(ServiceRequestID);
	}
	...
	public ChequePaymentRequest deleteChequePaymentRequest(
		ChequePaymentRequest chequePaymentRequest) throws SystemException {
		return chequePaymentRequestPersistence.remove(chequePaymentRequest);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(ChequePaymentRequest.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		...
		return chequePaymentRequestPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return chequePaymentRequestPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public ChequePaymentRequest fetchChequePaymentRequest(
		String ServiceRequestID) throws SystemException {
		return chequePaymentRequestPersistence.fetchByPrimaryKey(ServiceRequestID);
	}
	 ...
	 */
	@Override
	public ChequePaymentRequest getChequePaymentRequest(String ServiceRequestID)
		throws PortalException, SystemException {
		return chequePaymentRequestPersistence.findByPrimaryKey(ServiceRequestID);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return chequePaymentRequestPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<ChequePaymentRequest> getChequePaymentRequests(int start,
		int end) throws SystemException {
		return chequePaymentRequestPersistence.findAll(start, end);
	}
	 ...
	 */
	@Override
	public int getChequePaymentRequestsCount() throws SystemException {
		return chequePaymentRequestPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public ChequePaymentRequest updateChequePaymentRequest(
		ChequePaymentRequest chequePaymentRequest) throws SystemException {
		return chequePaymentRequestPersistence.update(chequePaymentRequest);
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("com.ifli.rapid.model.ChequePaymentRequest",
			chequePaymentRequestLocalService);
	}

	public void destroy() {
		PersistedModelLocalServiceRegistryUtil.unregister(
			"com.ifli.rapid.model.ChequePaymentRequest");
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = chequePaymentRequestPersistence.getDataSource();
	...
	private ChequePaymentRequestLocalServiceClpInvoker _clpInvoker = new ChequePaymentRequestLocalServiceClpInvoker();
}