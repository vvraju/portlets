...
import com.ifli.rapid.service.PaymentOptionTypesLocalService;
...
/**
 * Provides the base implementation for the payment option types local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.ifli.rapid.service.impl.PaymentOptionTypesLocalServiceImpl}.
 * </p>
 *
 * @author Satya Kola
 * @see com.ifli.rapid.service.impl.PaymentOptionTypesLocalServiceImpl
 * @see com.ifli.rapid.service.PaymentOptionTypesLocalServiceUtil
 * @generated
 */
public abstract class PaymentOptionTypesLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements PaymentOptionTypesLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.ifli.rapid.service.PaymentOptionTypesLocalServiceUtil} to access the payment option types local service.
	 */
	...
	@Override
	public PaymentOptionTypes addPaymentOptionTypes(
		PaymentOptionTypes paymentOptionTypes) throws SystemException {
		paymentOptionTypes.setNew(true);

		return paymentOptionTypesPersistence.update(paymentOptionTypes);
	}
	 ...
	 */
	@Override
	public PaymentOptionTypes createPaymentOptionTypes(
		String PaymentOptionTypesId) {
		return paymentOptionTypesPersistence.create(PaymentOptionTypesId);
	}
	...
	@Override
	public PaymentOptionTypes deletePaymentOptionTypes(
		String PaymentOptionTypesId) throws PortalException, SystemException {
		return paymentOptionTypesPersistence.remove(PaymentOptionTypesId);
	}
	...
	public PaymentOptionTypes deletePaymentOptionTypes(
		PaymentOptionTypes paymentOptionTypes) throws SystemException {
		return paymentOptionTypesPersistence.remove(paymentOptionTypes);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(PaymentOptionTypes.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		...
		return paymentOptionTypesPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return paymentOptionTypesPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public PaymentOptionTypes fetchPaymentOptionTypes(
		String PaymentOptionTypesId) throws SystemException {
		return paymentOptionTypesPersistence.fetchByPrimaryKey(PaymentOptionTypesId);
	}
	 ...
	 */
	@Override
	public PaymentOptionTypes getPaymentOptionTypes(String PaymentOptionTypesId)
		throws PortalException, SystemException {
		return paymentOptionTypesPersistence.findByPrimaryKey(PaymentOptionTypesId);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return paymentOptionTypesPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<PaymentOptionTypes> getPaymentOptionTypeses(int start, int end)
		throws SystemException {
		return paymentOptionTypesPersistence.findAll(start, end);
	}
	 ...
	 */
	@Override
	public int getPaymentOptionTypesesCount() throws SystemException {
		return paymentOptionTypesPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public PaymentOptionTypes updatePaymentOptionTypes(
		PaymentOptionTypes paymentOptionTypes) throws SystemException {
		return paymentOptionTypesPersistence.update(paymentOptionTypes);
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("com.ifli.rapid.model.PaymentOptionTypes",
			paymentOptionTypesLocalService);
	}

	public void destroy() {
		PersistedModelLocalServiceRegistryUtil.unregister(
			"com.ifli.rapid.model.PaymentOptionTypes");
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = paymentOptionTypesPersistence.getDataSource();
	...
	private PaymentOptionTypesLocalServiceClpInvoker _clpInvoker = new PaymentOptionTypesLocalServiceClpInvoker();
}