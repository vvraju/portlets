...
import com.ifli.rapid.service.ClosedServiceRequestsLocalService;
...
/**
 * Provides the base implementation for the closed service requests local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.ifli.rapid.service.impl.ClosedServiceRequestsLocalServiceImpl}.
 * </p>
 *
 * @author Satya Kola
 * @see com.ifli.rapid.service.impl.ClosedServiceRequestsLocalServiceImpl
 * @see com.ifli.rapid.service.ClosedServiceRequestsLocalServiceUtil
 * @generated
 */
public abstract class ClosedServiceRequestsLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements ClosedServiceRequestsLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.ifli.rapid.service.ClosedServiceRequestsLocalServiceUtil} to access the closed service requests local service.
	 */
	...
	@Override
	public ClosedServiceRequests addClosedServiceRequests(
		ClosedServiceRequests closedServiceRequests) throws SystemException {
		closedServiceRequests.setNew(true);

		return closedServiceRequestsPersistence.update(closedServiceRequests);
	}
	 ...
	 */
	@Override
	public ClosedServiceRequests createClosedServiceRequests(int QRC_CSR_ID) {
		return closedServiceRequestsPersistence.create(QRC_CSR_ID);
	}
	...
	@Override
	public ClosedServiceRequests deleteClosedServiceRequests(int QRC_CSR_ID)
		throws PortalException, SystemException {
		return closedServiceRequestsPersistence.remove(QRC_CSR_ID);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public ClosedServiceRequests deleteClosedServiceRequests(
		ClosedServiceRequests closedServiceRequests) throws SystemException {
		return closedServiceRequestsPersistence.remove(closedServiceRequests);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(ClosedServiceRequests.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		...
		return closedServiceRequestsPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return closedServiceRequestsPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public ClosedServiceRequests fetchClosedServiceRequests(int QRC_CSR_ID)
		throws SystemException {
		return closedServiceRequestsPersistence.fetchByPrimaryKey(QRC_CSR_ID);
	}
	 ...
	 */
	@Override
	public ClosedServiceRequests getClosedServiceRequests(int QRC_CSR_ID)
		throws PortalException, SystemException {
		return closedServiceRequestsPersistence.findByPrimaryKey(QRC_CSR_ID);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return closedServiceRequestsPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<ClosedServiceRequests> getClosedServiceRequestses(int start,
		int end) throws SystemException {
		return closedServiceRequestsPersistence.findAll(start, end);
	}
	 ...
	 */
	@Override
	public int getClosedServiceRequestsesCount() throws SystemException {
		return closedServiceRequestsPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public ClosedServiceRequests updateClosedServiceRequests(
		ClosedServiceRequests closedServiceRequests) throws SystemException {
		return closedServiceRequestsPersistence.update(closedServiceRequests);
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("com.ifli.rapid.model.ClosedServiceRequests",
			closedServiceRequestsLocalService);
	}

	public void destroy() {
		PersistedModelLocalServiceRegistryUtil.unregister(
			"com.ifli.rapid.model.ClosedServiceRequests");
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = closedServiceRequestsPersistence.getDataSource();
	...
	private ClosedServiceRequestsLocalServiceClpInvoker _clpInvoker = new ClosedServiceRequestsLocalServiceClpInvoker();
}