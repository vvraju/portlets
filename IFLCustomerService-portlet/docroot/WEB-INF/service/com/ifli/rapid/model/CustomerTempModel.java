...
/**
 * The base model interface for the CustomerTemp service. Represents a row in the &quot;customer_temp&quot; database table, with each column mapped to a property of this class.
 *
 * <p>
 * This interface and its corresponding implementation {@link com.ifli.rapid.model.impl.CustomerTempModelImpl} exist only as a container for the default property accessors generated by ServiceBuilder. Helper methods and all application logic should be put in {@link com.ifli.rapid.model.impl.CustomerTempImpl}.
 * </p>
 *
 * @author Satya Kola
 * @see CustomerTemp
 ...
 * @generated
 */
public interface CustomerTempModel extends BaseModel<CustomerTemp> {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. All methods that expect a customer temp model instance should use the {@link CustomerTemp} interface instead.
	 */
