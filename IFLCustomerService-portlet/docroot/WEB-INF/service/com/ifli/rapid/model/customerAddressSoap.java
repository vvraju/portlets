 ...
 * @generated
 */
public class customerAddressSoap implements Serializable {
	public static customerAddressSoap toSoapModel(customerAddress model) {
		customerAddressSoap soapModel = new customerAddressSoap();
	...
	public static customerAddressSoap[] toSoapModels(customerAddress[] models) {
		customerAddressSoap[] soapModels = new customerAddressSoap[models.length];
	...
	public static customerAddressSoap[][] toSoapModels(
		customerAddress[][] models) {
		customerAddressSoap[][] soapModels = null;

		if (models.length > 0) {
			soapModels = new customerAddressSoap[models.length][models[0].length];
		}
		else {
			soapModels = new customerAddressSoap[0][0];
		}
	...
	public static customerAddressSoap[] toSoapModels(
		List<customerAddress> models) {
		List<customerAddressSoap> soapModels = new ArrayList<customerAddressSoap>(models.size());

		for (customerAddress model : models) {
			soapModels.add(toSoapModel(model));
		}

		return soapModels.toArray(new customerAddressSoap[soapModels.size()]);
	}

	public customerAddressSoap() {
	}
