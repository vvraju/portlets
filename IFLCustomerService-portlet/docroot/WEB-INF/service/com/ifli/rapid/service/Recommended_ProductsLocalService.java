...
/**
 * Provides the local service interface for Recommended_Products. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Satya Kola
 * @see Recommended_ProductsLocalServiceUtil
...
public interface Recommended_ProductsLocalService extends BaseLocalService,
	InvokableLocalService, PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link Recommended_ProductsLocalServiceUtil} to access the recommended_ products local service. Add custom service methods to {@link com.ifli.rapid.service.impl.Recommended_ProductsLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
