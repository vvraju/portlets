...
/**
 * Provides the local service interface for PolicyFundSwitchDetails. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Satya Kola
 * @see PolicyFundSwitchDetailsLocalServiceUtil
...
public interface PolicyFundSwitchDetailsLocalService extends BaseLocalService,
	InvokableLocalService, PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link PolicyFundSwitchDetailsLocalServiceUtil} to access the policy fund switch details local service. Add custom service methods to {@link com.ifli.rapid.service.impl.PolicyFundSwitchDetailsLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
