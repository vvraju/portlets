...
/**
 * The persistence utility for the payment details service. This utility wraps {@link PaymentDetailsPersistenceImpl} and provides direct access to the database for CRUD operations. This utility should only be used by the service layer, as it must operate within a transaction. Never access this utility in a JSP, controller, model, or other front-end class.
 *
 * <p>
...
public class PaymentDetailsUtil {
	 ...
	 */
	public static void clearCache(PaymentDetails paymentDetails) {
		getPersistence().clearCache(paymentDetails);
	}
	 ...
	 */
	public static List<PaymentDetails> findWithDynamicQuery(
	 ...
	 */
	public static PaymentDetails update(PaymentDetails paymentDetails)
		throws SystemException {
		return getPersistence().update(paymentDetails);
	}
	...
	public static PaymentDetails update(PaymentDetails paymentDetails,
		...
		return getPersistence().update(paymentDetails, serviceContext);
	}
	...
	*/
	public static void cacheResult(
		...
		getPersistence().cacheResult(paymentDetails);
	}
	...
	*/
	public static void cacheResult(
		...
		getPersistence().cacheResult(paymentDetailses);
	}
	...
	*/
	public static com.ifli.rapid.model.PaymentDetails create(int PaymentId) {
	...
	*/
	public static com.ifli.rapid.model.PaymentDetails remove(int PaymentId)
		throws com.ifli.rapid.NoSuchPaymentDetailsException,
			com.liferay.portal.kernel.exception.SystemException {
		return getPersistence().remove(PaymentId);
	}

	public static com.ifli.rapid.model.PaymentDetails updateImpl(
		com.ifli.rapid.model.PaymentDetails paymentDetails)
		throws com.liferay.portal.kernel.exception.SystemException {
		return getPersistence().updateImpl(paymentDetails);
	}
	...
	* @throws SystemException if a system exception occurred
	*/
	public static com.ifli.rapid.model.PaymentDetails findByPrimaryKey(
		int PaymentId)
		throws com.ifli.rapid.NoSuchPaymentDetailsException,
			com.liferay.portal.kernel.exception.SystemException {
	...
	* @throws SystemException if a system exception occurred
	*/
	public static com.ifli.rapid.model.PaymentDetails fetchByPrimaryKey(
		int PaymentId)
		throws com.liferay.portal.kernel.exception.SystemException {
	...
	* @throws SystemException if a system exception occurred
	*/
	public static java.util.List<com.ifli.rapid.model.PaymentDetails> findAll()
		throws com.liferay.portal.kernel.exception.SystemException {
	...
	*/
	...
	public static PaymentDetailsPersistence getPersistence() {
		if (_persistence == null) {
			_persistence = (PaymentDetailsPersistence)PortletBeanLocatorUtil.locate(com.ifli.rapid.service.ClpSerializer.getServletContextName(),
					PaymentDetailsPersistence.class.getName());

			ReferenceRegistry.registerReference(PaymentDetailsUtil.class,
				"_persistence");
		}
	 ...
	 */
	public void setPersistence(PaymentDetailsPersistence persistence) {
	}

	private static PaymentDetailsPersistence _persistence;
}