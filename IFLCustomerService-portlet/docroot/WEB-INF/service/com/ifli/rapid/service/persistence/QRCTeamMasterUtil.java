...
/**
 * The persistence utility for the q r c team master service. This utility wraps {@link QRCTeamMasterPersistenceImpl} and provides direct access to the database for CRUD operations. This utility should only be used by the service layer, as it must operate within a transaction. Never access this utility in a JSP, controller, model, or other front-end class.
 *
 * <p>
 ...
 * @generated
 */
public class QRCTeamMasterUtil {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 ...
	 */
	public static void clearCache(QRCTeamMaster qrcTeamMaster) {
		getPersistence().clearCache(qrcTeamMaster);
	}
	 ...
	 */
	public static List<QRCTeamMaster> findWithDynamicQuery(
	 ...
	 */
	public static QRCTeamMaster update(QRCTeamMaster qrcTeamMaster)
		throws SystemException {
		return getPersistence().update(qrcTeamMaster);
	}
	...
	public static QRCTeamMaster update(QRCTeamMaster qrcTeamMaster,
		...
		return getPersistence().update(qrcTeamMaster, serviceContext);
	}
	...
	*/
	public static void cacheResult(
		...
		getPersistence().cacheResult(qrcTeamMaster);
	}
	...
	*/
	public static void cacheResult(
		...
		getPersistence().cacheResult(qrcTeamMasters);
	}
	...
	*/
	public static com.ifli.rapid.model.QRCTeamMaster create(int QRC_TM_ID) {
		return getPersistence().create(QRC_TM_ID);
	}
	...
	*/
	public static com.ifli.rapid.model.QRCTeamMaster remove(int QRC_TM_ID)
		throws com.ifli.rapid.NoSuchQRCTeamMasterException,
			com.liferay.portal.kernel.exception.SystemException {
		return getPersistence().remove(QRC_TM_ID);
	}

	public static com.ifli.rapid.model.QRCTeamMaster updateImpl(
		com.ifli.rapid.model.QRCTeamMaster qrcTeamMaster)
		throws com.liferay.portal.kernel.exception.SystemException {
		return getPersistence().updateImpl(qrcTeamMaster);
	}
	...
	* @throws SystemException if a system exception occurred
	*/
	public static com.ifli.rapid.model.QRCTeamMaster findByPrimaryKey(
		int QRC_TM_ID)
		throws com.ifli.rapid.NoSuchQRCTeamMasterException,
			com.liferay.portal.kernel.exception.SystemException {
		return getPersistence().findByPrimaryKey(QRC_TM_ID);
	}
	...
	* @throws SystemException if a system exception occurred
	*/
	public static com.ifli.rapid.model.QRCTeamMaster fetchByPrimaryKey(
		int QRC_TM_ID)
		throws com.liferay.portal.kernel.exception.SystemException {
		return getPersistence().fetchByPrimaryKey(QRC_TM_ID);
	}
	...
	* @throws SystemException if a system exception occurred
	*/
	public static java.util.List<com.ifli.rapid.model.QRCTeamMaster> findAll()
		throws com.liferay.portal.kernel.exception.SystemException {
	...
	*/
	...
	public static QRCTeamMasterPersistence getPersistence() {
		if (_persistence == null) {
			_persistence = (QRCTeamMasterPersistence)PortletBeanLocatorUtil.locate(com.ifli.rapid.service.ClpSerializer.getServletContextName(),
					QRCTeamMasterPersistence.class.getName());

			ReferenceRegistry.registerReference(QRCTeamMasterUtil.class,
				"_persistence");
		}
	 ...
	 */
	public void setPersistence(QRCTeamMasterPersistence persistence) {
	}

	private static QRCTeamMasterPersistence _persistence;
}