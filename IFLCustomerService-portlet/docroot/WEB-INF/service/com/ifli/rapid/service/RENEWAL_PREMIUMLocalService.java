...
/**
 * Provides the local service interface for RENEWAL_PREMIUM. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Satya Kola
 * @see RENEWAL_PREMIUMLocalServiceUtil
...
public interface RENEWAL_PREMIUMLocalService extends BaseLocalService,
	InvokableLocalService, PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link RENEWAL_PREMIUMLocalServiceUtil} to access the r e n e w a l_ p r e m i u m local service. Add custom service methods to {@link com.ifli.rapid.service.impl.RENEWAL_PREMIUMLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
