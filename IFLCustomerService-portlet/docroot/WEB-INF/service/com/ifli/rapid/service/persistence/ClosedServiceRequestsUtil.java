...
/**
 * The persistence utility for the closed service requests service. This utility wraps {@link ClosedServiceRequestsPersistenceImpl} and provides direct access to the database for CRUD operations. This utility should only be used by the service layer, as it must operate within a transaction. Never access this utility in a JSP, controller, model, or other front-end class.
 *
 * <p>
 ...
 * @generated
 */
public class ClosedServiceRequestsUtil {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 ...
	 */
	public static void clearCache(ClosedServiceRequests closedServiceRequests) {
		getPersistence().clearCache(closedServiceRequests);
	}
	 ...
	 */
	public static List<ClosedServiceRequests> findWithDynamicQuery(
	 ...
	 */
	public static ClosedServiceRequests update(
		ClosedServiceRequests closedServiceRequests) throws SystemException {
		return getPersistence().update(closedServiceRequests);
	}
	...
	public static ClosedServiceRequests update(
		...
		return getPersistence().update(closedServiceRequests, serviceContext);
	}
	...
	*/
	public static void cacheResult(
		...
		getPersistence().cacheResult(closedServiceRequests);
	}
	...
	*/
	public static void cacheResult(
		...
		getPersistence().cacheResult(closedServiceRequestses);
	}
	...
	*/
	public static com.ifli.rapid.model.ClosedServiceRequests create(
		int QRC_CSR_ID) {
		return getPersistence().create(QRC_CSR_ID);
	}
	...
	*/
	public static com.ifli.rapid.model.ClosedServiceRequests remove(
		int QRC_CSR_ID)
		throws com.ifli.rapid.NoSuchClosedServiceRequestsException,
			com.liferay.portal.kernel.exception.SystemException {
		return getPersistence().remove(QRC_CSR_ID);
	}

	public static com.ifli.rapid.model.ClosedServiceRequests updateImpl(
		com.ifli.rapid.model.ClosedServiceRequests closedServiceRequests)
		throws com.liferay.portal.kernel.exception.SystemException {
		return getPersistence().updateImpl(closedServiceRequests);
	}
	...
	* @throws SystemException if a system exception occurred
	*/
	public static com.ifli.rapid.model.ClosedServiceRequests findByPrimaryKey(
		int QRC_CSR_ID)
		throws com.ifli.rapid.NoSuchClosedServiceRequestsException,
			com.liferay.portal.kernel.exception.SystemException {
		return getPersistence().findByPrimaryKey(QRC_CSR_ID);
	}
	...
	* @throws SystemException if a system exception occurred
	*/
	public static com.ifli.rapid.model.ClosedServiceRequests fetchByPrimaryKey(
		int QRC_CSR_ID)
		throws com.liferay.portal.kernel.exception.SystemException {
		return getPersistence().fetchByPrimaryKey(QRC_CSR_ID);
	}
	...
	* @throws SystemException if a system exception occurred
	*/
	public static java.util.List<com.ifli.rapid.model.ClosedServiceRequests> findAll()
		throws com.liferay.portal.kernel.exception.SystemException {
	...
	*/
	...
	public static ClosedServiceRequestsPersistence getPersistence() {
		if (_persistence == null) {
			_persistence = (ClosedServiceRequestsPersistence)PortletBeanLocatorUtil.locate(com.ifli.rapid.service.ClpSerializer.getServletContextName(),
					ClosedServiceRequestsPersistence.class.getName());

			ReferenceRegistry.registerReference(ClosedServiceRequestsUtil.class,
				"_persistence");
		}
	 ...
	 */
	public void setPersistence(ClosedServiceRequestsPersistence persistence) {
	}

	private static ClosedServiceRequestsPersistence _persistence;
}