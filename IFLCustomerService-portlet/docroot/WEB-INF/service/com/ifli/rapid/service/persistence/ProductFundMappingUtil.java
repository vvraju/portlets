...
/**
 * The persistence utility for the product fund mapping service. This utility wraps {@link ProductFundMappingPersistenceImpl} and provides direct access to the database for CRUD operations. This utility should only be used by the service layer, as it must operate within a transaction. Never access this utility in a JSP, controller, model, or other front-end class.
 *
 * <p>
 ...
 * @generated
 */
public class ProductFundMappingUtil {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 ...
	 */
	public static void clearCache(ProductFundMapping productFundMapping) {
		getPersistence().clearCache(productFundMapping);
	}
	 ...
	 */
	public static List<ProductFundMapping> findWithDynamicQuery(
	 ...
	 */
	public static ProductFundMapping update(
		ProductFundMapping productFundMapping) throws SystemException {
		return getPersistence().update(productFundMapping);
	}
	 ...
	 */
	public static ProductFundMapping update(
		ProductFundMapping productFundMapping, ServiceContext serviceContext)
		throws SystemException {
		return getPersistence().update(productFundMapping, serviceContext);
	}
	...
	*/
	public static void cacheResult(
		...
		getPersistence().cacheResult(productFundMapping);
	}
	...
	*/
	public static void cacheResult(
		...
		getPersistence().cacheResult(productFundMappings);
	}
	...
	*/
	public static com.ifli.rapid.model.ProductFundMapping create(int ID) {
	...
	*/
	public static com.ifli.rapid.model.ProductFundMapping remove(int ID)
		throws com.ifli.rapid.NoSuchProductFundMappingException,
			com.liferay.portal.kernel.exception.SystemException {
		return getPersistence().remove(ID);
	}

	public static com.ifli.rapid.model.ProductFundMapping updateImpl(
		com.ifli.rapid.model.ProductFundMapping productFundMapping)
		throws com.liferay.portal.kernel.exception.SystemException {
		return getPersistence().updateImpl(productFundMapping);
	}
	...
	* @throws SystemException if a system exception occurred
	*/
	public static com.ifli.rapid.model.ProductFundMapping findByPrimaryKey(
		int ID)
		throws com.ifli.rapid.NoSuchProductFundMappingException,
			com.liferay.portal.kernel.exception.SystemException {
	...
	* @throws SystemException if a system exception occurred
	*/
	public static com.ifli.rapid.model.ProductFundMapping fetchByPrimaryKey(
	...
	* @throws SystemException if a system exception occurred
	*/
	public static java.util.List<com.ifli.rapid.model.ProductFundMapping> findAll()
		throws com.liferay.portal.kernel.exception.SystemException {
	...
	*/
	...
	public static ProductFundMappingPersistence getPersistence() {
		if (_persistence == null) {
			_persistence = (ProductFundMappingPersistence)PortletBeanLocatorUtil.locate(com.ifli.rapid.service.ClpSerializer.getServletContextName(),
					ProductFundMappingPersistence.class.getName());

			ReferenceRegistry.registerReference(ProductFundMappingUtil.class,
				"_persistence");
		}
	 ...
	 */
	public void setPersistence(ProductFundMappingPersistence persistence) {
	}

	private static ProductFundMappingPersistence _persistence;
}