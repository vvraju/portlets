...
/**
 * The persistence utility for the policy fund service. This utility wraps {@link PolicyFundPersistenceImpl} and provides direct access to the database for CRUD operations. This utility should only be used by the service layer, as it must operate within a transaction. Never access this utility in a JSP, controller, model, or other front-end class.
 *
 * <p>
...
public class PolicyFundUtil {
	 ...
	 */
	public static void clearCache(PolicyFund policyFund) {
		getPersistence().clearCache(policyFund);
	}
	 ...
	 */
	public static List<PolicyFund> findWithDynamicQuery(
	 ...
	 */
	public static PolicyFund update(PolicyFund policyFund)
		throws SystemException {
		return getPersistence().update(policyFund);
	}
	...
	public static PolicyFund update(PolicyFund policyFund,
		...
		return getPersistence().update(policyFund, serviceContext);
	}
	...
	*/
	public static void cacheResult(com.ifli.rapid.model.PolicyFund policyFund) {
		getPersistence().cacheResult(policyFund);
	}
	...
	*/
	public static void cacheResult(
		...
		getPersistence().cacheResult(policyFunds);
	}
	...
	*/
	public static com.ifli.rapid.model.PolicyFund create(int POLICY_FUND_ID) {
		return getPersistence().create(POLICY_FUND_ID);
	}
	...
	*/
	public static com.ifli.rapid.model.PolicyFund remove(int POLICY_FUND_ID)
		throws com.ifli.rapid.NoSuchPolicyFundException,
			com.liferay.portal.kernel.exception.SystemException {
		return getPersistence().remove(POLICY_FUND_ID);
	}

	public static com.ifli.rapid.model.PolicyFund updateImpl(
		com.ifli.rapid.model.PolicyFund policyFund)
		throws com.liferay.portal.kernel.exception.SystemException {
		return getPersistence().updateImpl(policyFund);
	}
	...
	* @throws SystemException if a system exception occurred
	*/
	public static com.ifli.rapid.model.PolicyFund findByPrimaryKey(
		int POLICY_FUND_ID)
		throws com.ifli.rapid.NoSuchPolicyFundException,
			com.liferay.portal.kernel.exception.SystemException {
		return getPersistence().findByPrimaryKey(POLICY_FUND_ID);
	}
	...
	* @throws SystemException if a system exception occurred
	*/
	public static com.ifli.rapid.model.PolicyFund fetchByPrimaryKey(
		int POLICY_FUND_ID)
		throws com.liferay.portal.kernel.exception.SystemException {
		return getPersistence().fetchByPrimaryKey(POLICY_FUND_ID);
	}
	...
	* @throws SystemException if a system exception occurred
	*/
	public static java.util.List<com.ifli.rapid.model.PolicyFund> findAll()
		throws com.liferay.portal.kernel.exception.SystemException {
	...
	*/
	...
	public static PolicyFundPersistence getPersistence() {
		if (_persistence == null) {
			_persistence = (PolicyFundPersistence)PortletBeanLocatorUtil.locate(com.ifli.rapid.service.ClpSerializer.getServletContextName(),
					PolicyFundPersistence.class.getName());

			ReferenceRegistry.registerReference(PolicyFundUtil.class,
				"_persistence");
		}
	 ...
	 */
	public void setPersistence(PolicyFundPersistence persistence) {
	}

	private static PolicyFundPersistence _persistence;
}