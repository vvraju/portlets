...
/**
 * The persistence utility for the q r c sub type master service. This utility wraps {@link QRCSubTypeMasterPersistenceImpl} and provides direct access to the database for CRUD operations. This utility should only be used by the service layer, as it must operate within a transaction. Never access this utility in a JSP, controller, model, or other front-end class.
 *
 * <p>
 ...
 * @generated
 */
public class QRCSubTypeMasterUtil {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 ...
	 */
	public static void clearCache(QRCSubTypeMaster qrcSubTypeMaster) {
		getPersistence().clearCache(qrcSubTypeMaster);
	}
	 ...
	 */
	public static List<QRCSubTypeMaster> findWithDynamicQuery(
	 ...
	 */
	public static QRCSubTypeMaster update(QRCSubTypeMaster qrcSubTypeMaster)
		throws SystemException {
		return getPersistence().update(qrcSubTypeMaster);
	}
	...
	public static QRCSubTypeMaster update(QRCSubTypeMaster qrcSubTypeMaster,
		...
		return getPersistence().update(qrcSubTypeMaster, serviceContext);
	}
	...
	*/
	public static void cacheResult(
		...
		getPersistence().cacheResult(qrcSubTypeMaster);
	}
	...
	*/
	public static void cacheResult(
		...
		getPersistence().cacheResult(qrcSubTypeMasters);
	}
	...
	*/
	public static com.ifli.rapid.model.QRCSubTypeMaster create(
		int QRC_SUB_TYPE_ID) {
		return getPersistence().create(QRC_SUB_TYPE_ID);
	}
	...
	*/
	public static com.ifli.rapid.model.QRCSubTypeMaster remove(
		int QRC_SUB_TYPE_ID)
		throws com.ifli.rapid.NoSuchQRCSubTypeMasterException,
			com.liferay.portal.kernel.exception.SystemException {
		return getPersistence().remove(QRC_SUB_TYPE_ID);
	}

	public static com.ifli.rapid.model.QRCSubTypeMaster updateImpl(
		com.ifli.rapid.model.QRCSubTypeMaster qrcSubTypeMaster)
		throws com.liferay.portal.kernel.exception.SystemException {
		return getPersistence().updateImpl(qrcSubTypeMaster);
	}
	...
	* @throws SystemException if a system exception occurred
	*/
	public static com.ifli.rapid.model.QRCSubTypeMaster findByPrimaryKey(
		int QRC_SUB_TYPE_ID)
		throws com.ifli.rapid.NoSuchQRCSubTypeMasterException,
			com.liferay.portal.kernel.exception.SystemException {
		return getPersistence().findByPrimaryKey(QRC_SUB_TYPE_ID);
	}
	...
	* @throws SystemException if a system exception occurred
	*/
	public static com.ifli.rapid.model.QRCSubTypeMaster fetchByPrimaryKey(
		int QRC_SUB_TYPE_ID)
		throws com.liferay.portal.kernel.exception.SystemException {
		return getPersistence().fetchByPrimaryKey(QRC_SUB_TYPE_ID);
	}
	...
	* @throws SystemException if a system exception occurred
	*/
	public static java.util.List<com.ifli.rapid.model.QRCSubTypeMaster> findAll()
		throws com.liferay.portal.kernel.exception.SystemException {
	...
	*/
	...
	public static QRCSubTypeMasterPersistence getPersistence() {
		if (_persistence == null) {
			_persistence = (QRCSubTypeMasterPersistence)PortletBeanLocatorUtil.locate(com.ifli.rapid.service.ClpSerializer.getServletContextName(),
					QRCSubTypeMasterPersistence.class.getName());

			ReferenceRegistry.registerReference(QRCSubTypeMasterUtil.class,
				"_persistence");
		}
	 ...
	 */
	public void setPersistence(QRCSubTypeMasterPersistence persistence) {
	}

	private static QRCSubTypeMasterPersistence _persistence;
}