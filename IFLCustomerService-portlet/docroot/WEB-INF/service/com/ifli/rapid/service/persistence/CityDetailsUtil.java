...
/**
 * The persistence utility for the city details service. This utility wraps {@link CityDetailsPersistenceImpl} and provides direct access to the database for CRUD operations. This utility should only be used by the service layer, as it must operate within a transaction. Never access this utility in a JSP, controller, model, or other front-end class.
 *
 * <p>
...
public class CityDetailsUtil {
	 ...
	 */
	public static void clearCache(CityDetails cityDetails) {
		getPersistence().clearCache(cityDetails);
	}
	 ...
	 */
	public static List<CityDetails> findWithDynamicQuery(
	 ...
	 */
	public static CityDetails update(CityDetails cityDetails)
		throws SystemException {
		return getPersistence().update(cityDetails);
	}
	...
	public static CityDetails update(CityDetails cityDetails,
		...
		return getPersistence().update(cityDetails, serviceContext);
	}
	...
	*/
	public static void cacheResult(com.ifli.rapid.model.CityDetails cityDetails) {
		getPersistence().cacheResult(cityDetails);
	}
	...
	*/
	public static void cacheResult(
		...
		getPersistence().cacheResult(cityDetailses);
	}
	...
	*/
	public static com.ifli.rapid.model.CityDetails create(int CITY_ID) {
	...
	*/
	public static com.ifli.rapid.model.CityDetails remove(int CITY_ID)
		throws com.ifli.rapid.NoSuchCityDetailsException,
			com.liferay.portal.kernel.exception.SystemException {
		return getPersistence().remove(CITY_ID);
	}

	public static com.ifli.rapid.model.CityDetails updateImpl(
		com.ifli.rapid.model.CityDetails cityDetails)
		throws com.liferay.portal.kernel.exception.SystemException {
		return getPersistence().updateImpl(cityDetails);
	}
	...
	* @throws SystemException if a system exception occurred
	*/
	public static com.ifli.rapid.model.CityDetails findByPrimaryKey(int CITY_ID)
		throws com.ifli.rapid.NoSuchCityDetailsException,
			com.liferay.portal.kernel.exception.SystemException {
	...
	* @throws SystemException if a system exception occurred
	*/
	public static com.ifli.rapid.model.CityDetails fetchByPrimaryKey(
		int CITY_ID) throws com.liferay.portal.kernel.exception.SystemException {
	...
	* @throws SystemException if a system exception occurred
	*/
	public static java.util.List<com.ifli.rapid.model.CityDetails> findAll()
		throws com.liferay.portal.kernel.exception.SystemException {
	...
	*/
	...
	public static CityDetailsPersistence getPersistence() {
		if (_persistence == null) {
			_persistence = (CityDetailsPersistence)PortletBeanLocatorUtil.locate(com.ifli.rapid.service.ClpSerializer.getServletContextName(),
					CityDetailsPersistence.class.getName());

			ReferenceRegistry.registerReference(CityDetailsUtil.class,
				"_persistence");
		}
	 ...
	 */
	public void setPersistence(CityDetailsPersistence persistence) {
	}

	private static CityDetailsPersistence _persistence;
}