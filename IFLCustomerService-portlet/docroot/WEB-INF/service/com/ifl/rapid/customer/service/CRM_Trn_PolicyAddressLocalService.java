...
/**
 * Provides the local service interface for CRM_Trn_PolicyAddress. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Satya Kola
 * @see CRM_Trn_PolicyAddressLocalServiceUtil
...
public interface CRM_Trn_PolicyAddressLocalService extends BaseLocalService,
	InvokableLocalService, PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link CRM_Trn_PolicyAddressLocalServiceUtil} to access the c r m_ trn_ policy address local service. Add custom service methods to {@link com.ifl.rapid.customer.service.impl.CRM_Trn_PolicyAddressLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
