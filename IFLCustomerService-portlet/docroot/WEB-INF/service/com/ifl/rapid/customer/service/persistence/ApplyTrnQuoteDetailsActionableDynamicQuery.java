 ...
 * @generated
 */
public abstract class ApplyTrnQuoteDetailsActionableDynamicQuery
	extends BaseActionableDynamicQuery {
	public ApplyTrnQuoteDetailsActionableDynamicQuery()
		throws SystemException {
		setBaseLocalService(ApplyTrnQuoteDetailsLocalServiceUtil.getService());
		setClass(ApplyTrnQuoteDetails.class);

		setClassLoader(com.ifl.rapid.customer.service.ClpSerializer.class.getClassLoader());

		setPrimaryKeyPropertyName("QuoteId");
	}
}