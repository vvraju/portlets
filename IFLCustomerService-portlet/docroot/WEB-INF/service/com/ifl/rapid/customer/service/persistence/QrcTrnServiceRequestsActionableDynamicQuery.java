 ...
 * @generated
 */
public abstract class QrcTrnServiceRequestsActionableDynamicQuery
	extends BaseActionableDynamicQuery {
	public QrcTrnServiceRequestsActionableDynamicQuery()
		throws SystemException {
		setBaseLocalService(QrcTrnServiceRequestsLocalServiceUtil.getService());
		setClass(QrcTrnServiceRequests.class);

		setClassLoader(com.ifl.rapid.customer.service.ClpSerializer.class.getClassLoader());

		setPrimaryKeyPropertyName("ServiceRequestId");
	}
}