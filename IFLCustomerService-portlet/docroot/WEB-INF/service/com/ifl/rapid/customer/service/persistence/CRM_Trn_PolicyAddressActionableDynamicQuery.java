 ...
 * @generated
 */
public abstract class CRM_Trn_PolicyAddressActionableDynamicQuery
	extends BaseActionableDynamicQuery {
	public CRM_Trn_PolicyAddressActionableDynamicQuery()
		throws SystemException {
		setBaseLocalService(CRM_Trn_PolicyAddressLocalServiceUtil.getService());
		setClass(CRM_Trn_PolicyAddress.class);

		setClassLoader(com.ifl.rapid.customer.service.ClpSerializer.class.getClassLoader());

		setPrimaryKeyPropertyName("PolicyAddressId");
	}
}