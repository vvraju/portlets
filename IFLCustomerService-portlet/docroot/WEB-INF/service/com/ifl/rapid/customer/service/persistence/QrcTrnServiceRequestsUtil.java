...
/**
 * The persistence utility for the qrc trn service requests service. This utility wraps {@link QrcTrnServiceRequestsPersistenceImpl} and provides direct access to the database for CRUD operations. This utility should only be used by the service layer, as it must operate within a transaction. Never access this utility in a JSP, controller, model, or other front-end class.
 *
 * <p>
 ...
 * @see QrcTrnServiceRequestsPersistenceImpl
 * @generated
 */
public class QrcTrnServiceRequestsUtil {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 ...
	 */
	public static void clearCache(QrcTrnServiceRequests qrcTrnServiceRequests) {
		getPersistence().clearCache(qrcTrnServiceRequests);
	}
	 ...
	 */
	public static List<QrcTrnServiceRequests> findWithDynamicQuery(
	 ...
	 */
	public static QrcTrnServiceRequests update(
		QrcTrnServiceRequests qrcTrnServiceRequests) throws SystemException {
		return getPersistence().update(qrcTrnServiceRequests);
	}
	...
	public static QrcTrnServiceRequests update(
		...
		return getPersistence().update(qrcTrnServiceRequests, serviceContext);
	}
	...
	*/
	public static void cacheResult(
		...
		getPersistence().cacheResult(qrcTrnServiceRequests);
	}
	...
	*/
	public static void cacheResult(
		java.util.List<com.ifl.rapid.customer.model.QrcTrnServiceRequests> qrcTrnServiceRequestses) {
		getPersistence().cacheResult(qrcTrnServiceRequestses);
	}
	...
	*/
	public static com.ifl.rapid.customer.model.QrcTrnServiceRequests create(
	...
	*/
	public static com.ifl.rapid.customer.model.QrcTrnServiceRequests remove(
		int ServiceRequestId)
		throws com.ifl.rapid.customer.NoSuchQrcTrnServiceRequestsException,
			com.liferay.portal.kernel.exception.SystemException {
		return getPersistence().remove(ServiceRequestId);
	}

	public static com.ifl.rapid.customer.model.QrcTrnServiceRequests updateImpl(
		com.ifl.rapid.customer.model.QrcTrnServiceRequests qrcTrnServiceRequests)
		throws com.liferay.portal.kernel.exception.SystemException {
		return getPersistence().updateImpl(qrcTrnServiceRequests);
	}
	...
	* @throws SystemException if a system exception occurred
	*/
	public static com.ifl.rapid.customer.model.QrcTrnServiceRequests findByPrimaryKey(
		int ServiceRequestId)
		throws com.ifl.rapid.customer.NoSuchQrcTrnServiceRequestsException,
			com.liferay.portal.kernel.exception.SystemException {
	...
	* @throws SystemException if a system exception occurred
	*/
	public static com.ifl.rapid.customer.model.QrcTrnServiceRequests fetchByPrimaryKey(
		int ServiceRequestId)
		throws com.liferay.portal.kernel.exception.SystemException {
	...
	* @throws SystemException if a system exception occurred
	*/
	public static java.util.List<com.ifl.rapid.customer.model.QrcTrnServiceRequests> findAll()
		throws com.liferay.portal.kernel.exception.SystemException {
	...
	*/
	...
	public static QrcTrnServiceRequestsPersistence getPersistence() {
		if (_persistence == null) {
			_persistence = (QrcTrnServiceRequestsPersistence)PortletBeanLocatorUtil.locate(com.ifl.rapid.customer.service.ClpSerializer.getServletContextName(),
					QrcTrnServiceRequestsPersistence.class.getName());

			ReferenceRegistry.registerReference(QrcTrnServiceRequestsUtil.class,
				"_persistence");
		}
	 ...
	 */
	public void setPersistence(QrcTrnServiceRequestsPersistence persistence) {
	}

	private static QrcTrnServiceRequestsPersistence _persistence;
}