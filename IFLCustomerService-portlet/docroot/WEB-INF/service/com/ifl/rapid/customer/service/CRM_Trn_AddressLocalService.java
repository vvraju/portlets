...
/**
 * Provides the local service interface for CRM_Trn_Address. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Satya Kola
 * @see CRM_Trn_AddressLocalServiceUtil
...
public interface CRM_Trn_AddressLocalService extends BaseLocalService,
	InvokableLocalService, PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link CRM_Trn_AddressLocalServiceUtil} to access the c r m_ trn_ address local service. Add custom service methods to {@link com.ifl.rapid.customer.service.impl.CRM_Trn_AddressLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
