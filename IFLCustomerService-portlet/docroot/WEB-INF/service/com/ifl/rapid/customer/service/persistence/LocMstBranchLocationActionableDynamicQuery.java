 ...
 * @generated
 */
public abstract class LocMstBranchLocationActionableDynamicQuery
	extends BaseActionableDynamicQuery {
	public LocMstBranchLocationActionableDynamicQuery()
		throws SystemException {
		setBaseLocalService(LocMstBranchLocationLocalServiceUtil.getService());
		setClass(LocMstBranchLocation.class);

		setClassLoader(com.ifl.rapid.customer.service.ClpSerializer.class.getClassLoader());

		setPrimaryKeyPropertyName("BranchId");
	}
}