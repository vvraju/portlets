...
<portlet:renderURL var="renewalPremiumReceipt">
	<portlet:param name="action" value="renewalPremiumReceipt" />
</portlet:renderURL>
		...
		<div class="span12">
	        <div class="span3 profile-list-alerts-big" style="background:#b1d8e7;">
				<div class="">				
					...
					<span class="RenewalPremiumsingle">Renewal Premium Receipt</span>				
				</div>	
				<div class="clr"></div>                
			</div>
			...
			<div class="span9">
				...
				<h3>Renewal Premium Receipt</h3>
					...
					<div style="height:10px;margin-top:-20px;"> </div>
					 <a href="<%=renewalPremiumReceipt %>" rel="<%=renewalPremiumReceipt %>" target="_self" class="btn right" target="6" style="margin-bottom:10px;margin-right:12px;"> Action </a>					  				
				</div>
			</div>
		</div>
    </div>
